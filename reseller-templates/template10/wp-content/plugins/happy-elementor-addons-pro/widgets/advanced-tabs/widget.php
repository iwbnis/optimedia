    ...
    protected function register_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .ha-tabs-{{ID}}.ha-tabs--icon-left > .ha-tabs__nav > .ha-tab__title--desktop .ha-tab__title-icon' => 'margin-right: {{SIZE}}px;',
                    '{{WRAPPER}} .ha-tabs-{{ID}}.ha-tabs--icon-right > .ha-tabs__nav > .ha-tab__title--desktop .ha-tab__title-icon' => 'margin-left: {{SIZE}}px;',
                    '{{WRAPPER}} .ha-tabs-{{ID}}.ha-tabs--icon-top > .ha-tabs__nav > .ha-tab__title--desktop .ha-tab__title-icon' => 'margin-bottom: {{SIZE}}px;',
                    '{{WRAPPER}} .ha-tabs-{{ID}}.ha-tabs--icon-bottom  > .ha-tabs__nav > .ha-tab__title--desktop .ha-tab__title-icon' => 'margin-top: {{SIZE}}px;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .ha-tabs-{{ID}} > .ha-tabs__nav > .ha-tab__title--desktop .ha-tab__title-icon > i' => 'font-size: {{SIZE}}px;',
                    '{{WRAPPER}} .ha-tabs-{{ID}} > .ha-tabs__nav > .ha-tab__title--desktop .ha-tab__title-icon > svg' => 'width: {{SIZE}}px;',
                ],
            ]
        );
        ...
        <div <?php $this->print_render_attribute_string( 'tabs_wrapper' ); ?>>
			<div class="ha-tabs__nav">
				...
				foreach ( $tabs as $index => $item ) :
					...
					<div <?php echo $this->get_render_attribute_string( $tab_title_setting_key ); ?>>
                        ...
                        <?php endif; ?>
                        <span class="ha-tab__title-text"><?php echo ha_kses_basic( $item['title'] ); ?></span></div>
				<?php endforeach; ?>
			</div>
			<div class="ha-tabs__content">
				...
				foreach ( $tabs as $index => $item ) :
					...
					?>
					<div <?php echo $this->get_render_attribute_string( $tab_title_mobile_setting_key ); ?>><span class="ha-tab__title-text"><?php echo ha_kses_basic( $item['title'] ); ?></span></div>

            ...
            <div class="domain-pricing">
                ...
                <div class="bg-white tt-domain-list-wrap tt-custom-radius">
                    <div class="row no-gutters tld-pricing-header text-center">
                        <div class="col-md-3 tld-column">{lang key='orderdomain'}</div>
                        <div class="col-md-9">
                    ...
                    <div class="domain-promo-box">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="tt-domains-register-transfer ml-2">
                                <h3 class="font-size-18 font-weight-bold no-wrap">{lang key='orderForm.addHosting'}</h3>
                                <p class="mb-0">{lang key='orderForm.chooseFromRange'}</p>
                            </div>
                        </div>

                        <p class="text-muted">{lang key='orderForm.packagesForBudget'}</p>
                    ...
                    <div class="col-md-6">
                        <div class="domain-promo-box">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="tt-domains-register-transfer ml-2">
                                    <h3 class="font-size-18 font-weight-bold">{lang key='orderForm.transferToUs'}</h3>
                                    <p class="mb-0">{lang key='orderForm.transferExtend'}*</p>
                                </div>
                            </div>
                            <p class="text-muted">* {lang key='orderForm.extendExclusions'}</p>

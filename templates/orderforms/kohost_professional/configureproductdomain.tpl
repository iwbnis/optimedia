    ...
    <div class="row">
        ...
        <div class="cart-body">
            <div class="header-lined">
                <h2 class="font-size-24">{$LANG.domaincheckerchoosedomain}</h2>
            </div>
                ...
                <div id="DomainSearchResults" class="w-hidden">
                    ...
                    <div id="searchDomainInfo">
                        ...
                        <div id="primaryLookupResult" class="domain-lookup-result domain-lookup-primary-results w-hidden unavailable-block">
                            <div class="domain-unavailable domain-checker-unavailable headline"><span class="domainSearch"><i class="far fa-times-circle"></i><br /></span> {lang key='orderForm.domainIsUnavailable'}</div>
                            <div class="domain-available domain-checker-available headline"><span class="domainSearch"><i class="far fa-check-circle"></i><br /></span> {$LANG.domainavailable1} <strong></strong> {$LANG.domainavailable2}
                            ...
                            <div class="transfer-eligible">
                                <p class="domain-checker-available headline"><span class="domainSearch"><i class="far fa-check-circle"></i><br /></span> {lang key='orderForm.transferEligible'}</p>
                                <p>{lang key='orderForm.transferUnlockBeforeContinuing'}</p>
                            </div>
                            <div class="transfer-not-eligible">
                                <p class="domain-checker-unavailable headline"><span class="domainSearch"><i class="far fa-times-circle"></i><br /></span> {lang key='orderForm.transferNotEligible'}</p>
                                <p>{lang key='orderForm.transferNotRegistered'}</p>
                                <p>{lang key='orderForm.trasnferRecentlyRegistered'}</p>
                                <p class="mb-0">{lang key='orderForm.transferAlternativelyRegister'}</p>
                            </div>
                            <div class="domain-invalid">
                                <p class="domain-checker-unavailable headline"><span class="domainSearch"><i class="far fa-times-circle"></i><br /></span> {lang key='orderForm.domainInvalid'}</p>
                                <p>
                                        ...
                                        <div class="spotlight-tld-container spotlight-tld-container-{$spotlightTlds|count}">
                                            <div id="spotlight{$data.tldNoDots}" class="spotlight-tld">
                                                ...
                                                <div class="domain-lookup-result">
                                                    ...
                                                    <button type="button" class="btn primary-solid-btn domain-contact-support w-hidden">{lang key='domainChecker.contactSupport'}</button>
                                                </div>
                                            </div>
                                        </div>
                                    {/foreach}

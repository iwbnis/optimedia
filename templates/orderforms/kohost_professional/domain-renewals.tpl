    ...
    <div class="row">
        ...
        <div class="cart-body">
            ...
            {if $totalDomainCount == 0}
                {include file="$template/includes/no-data.tpl" msg={$LANG.domainRenewal.noDomains} btnText={$LANG.orderForm.returnToClientArea} btnUrl="{$WEB_ROOT}/clientarea.php" btnClass="outline-btn" btnIcon="fas fa-reply"}
            {else}
                <div class="row">
                            ...
                            {foreach $renewalsData as $renewalData}
                                <div class="domain-renewal" data-domain="{$renewalData.domain}">
                                    ...
                                    <div class="text-left">
                                        ...
                                        {else}
                                            <button id="renewDomain{$renewalData.id}" class="btn primary-solid-btn btn-add-renewal-to-cart" data-domain-id="{$renewalData.id}">
                                                <span class="to-add">
                    ...
                    <div class="secondary-cart-sidebar" id="scrollingPanelContainer">
                        ...
                        <div id="orderSummary">
                            <div class="order-summary">
                                ...
                                <h2 class="font-size-24">{lang key='ordersummary'}</h2>
                                <div class="summary-container" id="producttotal"></div>
                                <div class="order-summary-actions">
                                    <a id="btnGoToCart" class="btn btn-block btn-checkout" href="{$WEB_ROOT}/cart.php?a=view">
                                        {lang key='viewcart'}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-block">
                        <button type="button" class="btn outline-btn" data-dismiss="modal">{lang key='no'}</button>
                        <button type="submit" class="btn primary-solid-btn">{lang key='yes'}</button>
                    </div>
                </div>
            </div>
        </div>

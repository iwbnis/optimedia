...
<html lang="en">
  ...
  <body>
   ...
   <!--   <div class="video-container">
      ...
      <section class="section">
        <h1>
          <img src="{$WEB_ROOT}/templates/{$template}/customfiles/assets-canada/Maple_Leaf.svg.png" alt="mapple leaf" style="width: 4rem" /> Welcome to IPTVCanada.vip – Your Destination 
		  for Premium IPTV Services in Canada!
          <img src="{$WEB_ROOT}/templates/{$template}/customfiles/assets-canada/Maple_Leaf.svg.png" alt="mapple leaf" style="width: 4rem" />
        </h1>
        <p>
          Are you looking for the ultimate entertainment experience that combines convenience, variety, and quality? Look no further! At IPTVCanada.vip, 
		  we bring you the finest services tailored to the Canadian audience.
        </p>
		            <a href="https://iptvcanada.vip/index.php?rp=/store/" class="custom-btn">Get Started</a>
    ...
    <section class="product-section border-bottom bg-black text-secondary">
      ...
      <section class="product-logos">
        <a href="https://iptvcanada.vip/index.php?rp=/store/iptv-box">
      ...
      <p class="text-center">
          <a href="https://iptvcanada.vip/index.php?rp=/store/iptv-box&currency=3" class="custom-btn">Get IPTV Box with 3 Months of IPTV Canada Now</a>
      </p>
    </section>
    ...
    <main>
      <section class="border-bottom padding-y border-bottom-invert">
        <section class="section flex superior-section">
          <article class="flex-grow-1-3">
            <h2>Why Choose IPTVCanada.vip?</h2>
            <ul class="list">
              <li>
              ...
              <li>
                <strong><b>IPTV Canada Reddit Recommendations::</b></strong> Discover why Reddit users recommend us as one of the best IPTV providers in Canada. 
				Join our growing community of satisfied customers and elevate your TV-watching experience today.
              </li>
			<li>
              ...
              <li>
                <strong><b>24/7 Customer Support:</b></strong> Our dedicated customer support team is available around the 
				clock to assist you with any questions or issues you may encounter.
              </li>
        ...
        <p class="text-center">
          <a href="https://iptvcanada.vip/index.php?rp=/store/canada-premium-tv-no-adult&currency=3" class="custom-btn">Get IPTV in Canada Now</a>
        </p>
      </section>
      ...
      <section class="border-bottom border-bottom-invert">
        <section class="section">
          <section class="padding-y">
		     <h2 class="text-center">Explore Our Canadian IPTV Packages</h2></br>
            <h3 class="text-center">IPTV Canada Subscription With Adult</h3>
			<p class="text-center"> Choose from a range of IPTV packages designed to cater to different preferences and needs. 
			Whether you're a sports enthusiast, a movie buff, or a fan of international content, we have the right plan for you. 
			Join our growing community of satisfied customers and elevate your TV-watching experience today. </p>
            <p class="text-center">
              <a href="https://iptvcanada.vip/index.php?rp=/store/canada-premium-tv-no-adult&currency=3" class="custom-btn">See All Plans</a>
            </p>
          </section>
          ...
          <h3 class="text-center mb-2">IPTV Canada Subscription without Adult</h3>
      ...
      <section class="border-bottom">
        <section class="section padding-y">
          ...
          <p class="text-center">Ready to elevate your entertainment experience? Contact us today 
		  to get started with the best IPTV services in Canada. </p>
		  <p class="text-center">
          <a href="https://iptvcanada.vip/index.php?rp=/store/canada-premium-tv-no-adult&currency=3" class="custom-btn">Subscribe to IPTV Canada Now!</a>
      ...
      <section class="border-bottom">
        <section class="section padding-y">
          <h2 class="text-center">Articles about Canada IPTV</h2>

          <section class="articles-container">
          </section>
 			<p class="text-center">
			          <a href="https://iptvcanada.vip/portfolio/iptvcanadavip" class="custom-btn">All Canada IPTV Articles</a>
			</p>
      ...
      <section class="section padding-y">
        <h2 class="text-center">Frequently Asked Questions about Canada IPTV</h2>
  ...
  <script>
    ...
    async function generatePlans() {
      const plansData = await getData("/getproducts3.php");
      ...
      for(let i=0; i<plansData.length; i++) {
        ...
        if(items) {
          for(let j=0; j<items.length; j++) {
            ...
            if(innerItem.productid === 207 && innerItem.currencycode === 'CAD') {
              productsOne.push(innerItem)
              // break
            }

            if(innerItem.productid === 212 && innerItem.currencycode === 'CAD') {
              productsOne.push(innerItem)
              // break
            }

            if(innerItem.productid === 217 && innerItem.currencycode === 'CAD') {
              productsOne.push(innerItem)
              // break
            }

            // -------------------------------------------
            if(innerItem.productid === 227 && innerItem.currencycode === 'CAD') {
              productsTwo.push(innerItem)
              // break
            }

            if(innerItem.productid === 232 && innerItem.currencycode === 'CAD') {
              productsTwo.push(innerItem)
              // break
            }

            if(innerItem.productid === 237 && innerItem.currencycode === 'CAD') {
              productsTwo.push(innerItem)
              // break
            }
          }
    ...
    async function generateFAQs() {
      const faqsData = await getData("https://iptvcanada.vip/whmcms_faq.php");
    ...
    async function generateArticles() {
      const articlesData = await getData("https://iptvcanada.vip/whmcms_portfolio.php");

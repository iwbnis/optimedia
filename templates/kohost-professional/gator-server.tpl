					...
					<div class="pill-nav-container" id="top-pillNav-container">
						<button class="move-btn prev-btn"><</button>
							<div class="pill-nav" id="top-pillNav">
								<button class="first-btn active" data-id="gator-tivimate">Tivimate</button>
								<button  data-id="gator-xciptv">XCIPTV</button>
								<button  data-id="gator-purple">Purple</button>
								<button  data-id="gator-smarters">IPTV Smarters</button>
								<button  data-id="gator-xciptvmodern">XCIPTV Modern</button>
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    <div class="hosting-promo-content">
                                        ...
                                        <a
                                            href="https://optimedia.tv/index.php/store/gator-server-plans"
...
<!--services section start-->
    ...
    <br/>
			<h2 class="text-white" id="channel-list"><center>Gator Server Channel Lineup</center></h2>	
    <br/>
    </section>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-12 col-lg-6 ">
                            ...
                            <div class="action-btns mt-4">
                                <a href="https://optimedia.tv/index.php/store/gator-server-plans" class="btn btn-brand-03">
                                    Order Gator IPTV Now
                                </a>
                            </div>
                        </div>

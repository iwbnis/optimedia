...
<form method="post" action="{$smarty.server.PHP_SELF}?step=3" enctype="multipart/form-data" role="form">
    ...
    <div id="loader" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255, 255, 255, 0.7); text-align: center;">
    ...
    <p>
        <input type="submit" id="openTicketSubmit" value="{$LANG.supportticketsticketsubmit}" class="btn primary-solid-btn{$captcha->getButtonClass($captchaForm)}" />
        <a href="supporttickets.php" class="btn outline-btn">{$LANG.cancel}</a>
    </p>

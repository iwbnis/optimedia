    ...
    <body style="overflow-x:hidden;">
            ...
            <div class="tvvideo-container">
			    <div class="tvvideo-header">
				    <h3 class="tvvideo-heading" style="text-decoration: underline;-webkit-text-decoration-color:gray;text-decoration-color:gray">CHOOSE FROM 4 USER-FRIENDLY APPS</h3>
					<div class="pill-nav-container" id="top-pillNav-container">
						<button class="move-btn prev-btn"><</button>
							<div class="pill-nav" id="top-pillNav">
								<button class="first-btn active" data-id="supreme-tivimate">Tivimate</button>
								<button  data-id="supreme-xciptv">XCIPTV</button>
								<button  data-id="supreme-purple">Purple</button>
								<button  data-id="supreme-smarters">IPTV Smarters</button>
								<button  data-id="supreme-xciptvmodern">XCIPTV Modern</button>
                ...
                <!--<video  width="1000" height="500" autoplay muted loop id="myVideo">
                    <source src="{$WEB_ROOT}/templates/{$template}/customfiles/assets/img/video/choice2.mp4" type="video/mp4">
                    Your browser does not support HTML5 video.
                </video>-->
                ...
                <!--
                    <div class="content">
                    <h1>Heading</h1>
                    <p>Lorem ipsum dolor sit amet, an hi delicatissimi pro.</p>
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    <div class="hosting-promo-content">
                                        ...
                                        <p>
                                            Access over 10,000+ premium VIP
                                        ...
                                        <a
                                            href="/index.php/store/supreme-server-iptv-subscription-packages"
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    <div class="hosting-promo-content">
                                        ...
                                        <p>
                                            Access over 20,000 movies and tv
                    ...
                    >
                        ...
                        <div class="col-md-7 col-lg-6 details">
                            <div class="feature-content-wrap">
                                <h2>
                                    Best International & Stable IPTV and On Demand IPTV
                                </h2>
                                <p>
...
<!--services section start-->
    ...
    <br/>
			<h2 class="text-white" id="channel-list"><center>Supreme Server Channel Lineup</center></h2>	
    <br/>
    </section>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-12 col-lg-6 ">
                            ...
                            <div class="action-btns mt-4">
                                <a href="/index.php/store/supreme-server-iptv-subscription-packages" class="btn btn-brand-03">
                                    Order Supreme IPTV Now
                                </a>
                            </div>
                        </div>

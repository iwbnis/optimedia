<html lang="en">
    ...
    <body style="overflow-x:hidden;">
            ...
            <div class="tvvideo-container"  style="margin-top:-60px" id="iptv-servers">
                <div class="tvvideo-header">
                    <h3 class="tvvideo-heading" style="text-decoration: underline;-webkit-text-decoration-color:gray;text-decoration-color:gray">IPTV SERVERS FOR MAG DEVICES. </h3>
                    <div class="pill-nav-container" id="top-pillNav-container">
                        <button class="move-btn prev-btn"><</button>
                            <div class="pill-nav" id="top-pillNav">
                                <button class="first-btn active" data-id="gator">Gator</button>
                                <button class="last-btn" data-id="supreme">Supreme</button>
...
<!--services section start-->
                ...
                <div class="row" >
                    <div class="col-md-12 col-lg-12">
                        <div class="table-responsive" style="width:200%">
                            <table class="table w-50 table-hover table-bordered comparision-table text-center">
                                ...
                                <tbody class="comparision-table-body">
                                    <tr>
										...
										<td class="py-4">
											<p class="popup" style="color:green" onclick="myFunction()">1 MAG Device 
                                            ...
                                            <a href="https://optimedia.tv/index.php/store/supreme-mag-devices-only" class="btn outline-btn animated-btn mr-lg-3">Try Now</a>
                                        </td>
                                        <td class="py-4">
											<p class="popup" style="color:green" onclick="myFunction()">1 MAG Device 
											<span class="fa fa-question-circle color-primary"> <span class="popuptext" id="myPopup">Devices connected at the same time.</span></span></p>
                                            ...
                                            <a href="https://optimedia.tv/index.php/store/gatormag-devices-only" class="btn outline-btn animated-btn mr-lg-3">Try Now</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
									...
									<tr>
                                        ...
                                        <td><a href="/cart.php?a=add&pid=132" class="btn outline-btn animated-btn mr-lg-3">Free Trial Supreme </a></td>
                                        <td><a href="/cart.php?a=add&pid=131" class="btn outline-btn animated-btn mr-lg-3">Free Trial Gator</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <span class="channelList-page" style="display:none;"></span>

    <section class="ptb-55 primary-bg" style="margin-top:-20px">
        <br/>
        <h2 class="text-white"><center>CHANNEL LIST</center></h2>

        <div class="pill-nav-container bottomPillNavContainer" id="channelList-pillNav-container">
            <button class="move-btn prev-btn"><</button>
            <div class="pill-nav bottomPillNav" id="channelList-pillNav">
                <button class="first-btn active" data-list="gator">Gator</button>
                <button class="last-btn"  data-list="supreme">Supreme</button>
            </div>
            <button class="move-btn next-btn">></button>
        </div>
    </section>
    <section class="channel-list-container active" id="channel-list">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-12 col-lg-6 ">
                            ...
                            <div class="action-btns mt-4">
                                <a href="https://optimedia.tv/index.php/store/choice-server-plans" class="btn btn-brand-03">

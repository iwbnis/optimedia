					...
					<div class="pill-nav-container" id="top-pillNav-container">
						<button class="move-btn prev-btn"><</button>
							<div class="pill-nav" id="top-pillNav">
								...
								<button  data-id="americas-xciptv">XCIPTV</button>
								<button  data-id="americas-smarters">IPTV Smarters</button>
								<button  data-id="americas-purple">Purple</button>
								<button  data-id="americas-xciptvmodern">XCIPTV Modern</button>
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    <div class="hosting-promo-content">
                                        ...
                                        <p>
                                            Access over 27,000 movies and tv
                    ...
                    >
                        ...
                        <div class="col-md-7 col-lg-6 details">
                            <div class="feature-content-wrap">
                                <h2>
                                    Superior Live TV, Tailored for North & South America. 
                                </h2>
                                <p>
                                    Enjoy HD picture quality, and fast
                                    channel change. Watch thousands of movies
                                    and popular series on demand on any device. Tailored for North & South America live iptv channels.
                                </p>
                                <a
                                    href="#"
...
<!--services section start-->
   ...
   {include file="$template/plans.tpl"}
    ...
    <br/>
			<h2 class="text-white" id="channel-list"><center>Americas Server Channel Lineup</center></h2>	
    <br/>
    </section>
<p style=" text-align: center;color:red;"><strong> Below lists are rough idea of channels. Channel lists may not always be 100% accurate and will change without notice.</strong> </p>
        ...
        {include file="$template/americas-channel-list.tpl"}
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-12 col-lg-6 ">
                            ...
                            <div class="action-btns mt-4">
                                <a href="/index.php/store/americas" class="btn btn-brand-03">

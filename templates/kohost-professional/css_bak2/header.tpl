templates/kohost-professional/header.tpl
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>{if $kbarticle.title}{$kbarticle.title} {/if}{if $pagetitle} - {$pagetitle}}{/if} {if $companyname} - {$companyname}{/if}</title>
...
{$headeroutput}
	...
	<!--	<a href="https://optimedia.tv/contact.php" class="mr-3" style="color:#000000"><i class="fas fa-comment mr-1 color-accent"></i> <span>Email Us</span></a>
		...
		<a href="https://optimedia.tv/index.php?rp=/store" class="mb-0" style="color:#000000"><i class="fas fa-smile color-accent"></i> <span>Start Now</span></a>
		<a href="https://optimedia.tv/channel-list.php" class="mb-0" style="color:#000000"><i class="fas fa-list color-accent"></i> <span>Channel List</span></a>
		<a href="https://optimedia.tv/affiliates.php" class="mb-0" style="color:#000000"><i class="fas fa-dollar-sign"></i> <span>Affiliates</span></a>
...
{if $templatefile == 'homepage'}
   ...
   <section id="home-banner" class="hero-equal-height" style="background: url('templates/{$template}/img/header5.jpg')no-repeat center center / cover">
	...
	<section class="ptb-55" style="background-color:black !important;">
		...
		<!--	<h2 style="text-align: center;"><span style="color: #ffffff;"><a style="color: #ffffff;" href="https://optimedia.tv/index.php?rp=/store/">THE ULTIMATE TV EXPERIENCE AWAITS! ORDER NOW!</a></span></h2>-->
			<div style="text-align:center; padding-bottom:10px">
				<h2 style="display:inline; color:white;"><a style="color:white;" href="https://optimedia.tv/index.php/store/choice-no-adult-packages">Try IPTV Risk-Free with our 7-day Money-Back Guarantee.</a></h2>
...
<section>
    ...
    <section class="ptb-55" style="background-color:#0c8f51   !important;">
        <h2 style="text-align: center;"><span style="color: #ffffff;"><a style="color: #ffffff;" href="https://optimedia.tv/vpn.php">Avoid ISP throttling with a VPN for IPTV</a></span></h2>
        <p style="color: #ffffff; text-align: center;"> <a style="color: #ffffff;" href="https://optimedia.tv/vpn.php">Connect up to 10 devices at the same time. Click for details. </a></p>                  
    </section>
    -->
        ...
        <div class="container">
            <div class="row" style="display:flex;justify-content: center;">
                ...
                <!--<div class="col-md-6 col-lg-3 mb-4 mb-md-4 mb-lg-0"> 
                    <a id="btnOrderHosting" href="https://optimedia.tv/index.php?rp=/store/"> ->
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="cta-new-wrap">
                        ...
                        <div class="action-btns">
                            <a href="https://optimedia.tv/index.php/store/" class="btn outline-btn animated-btn mr-lg-3">Start Watching TV Now</a>
			 ...
			 <div class="col-md-6 col-lg-6">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="cta-new-wrap">
                        ...
                        <div class="action-btns">
                            <a href="https://optimedia.tv/index.php/store/" class="btn outline-btn animated-btn mr-lg-3">Start Watching Sports Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-center-row">
                <div class="col-md-6 col-lg-6">
                 ...
                 <!--       </ul>
                        <div class="action-btns">
                            <a href="https://optimedia.tv/index.php/store/vpn" class="btn outline-btn animated-btn mr-lg-3">Stop ISP Throttling & Start Watching TV Now</a>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="https://optimedia.tv/choice-server.php" class="btn outline-btn mt-3" style="font-size:12px">Choice</a>
                        <a href="https://optimedia.tv/index.php/store/americas" class="btn outline-btn mt-3" style="font-size:12px">Americas</a>
                        <a href="https://optimedia.tv/cart.php?gid=40" class="btn outline-btn mt-3" style="font-size:12px">USA</a>
                        <a href="https://optimedia.tv/index.php/store/canada-premium-tv-no-adult" class="btn outline-btn mt-3" style="font-size:12px">Canada</a>
                        <a href="https://optimedia.tv/cart.php?gid=41" class="btn outline-btn mt-3" style="font-size:12px">English</a>
				</div>
                </div>
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="https://optimedia.tv/index.php/store/" class="btn outline-btn mt-3" style="font-size:12px">STREAM TV SHOWS</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="https://optimedia.tv/index.php/store/" class="btn outline-btn mt-3" style="font-size:12px">STREAM VOD</a>
                ...
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="https://optimedia.tv/index.php/store/" class="btn outline-btn mt-3" style="font-size:12px">WATCH PREMIUM SPORTS</a>
                    </div>
                </div>
            </div>
        </div>

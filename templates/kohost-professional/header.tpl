...
<head>
  ...
  <!--    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-136347717-1"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-136347717-1');
        </script>-->
		<!-- Google tag (gtag.js) -->
	<!--	<script async src="https://www.googletagmanager.com/gtag/js?id=G-65GZBP6TJ1"></script>
			<script>
				window.dataLayer = window.dataLayer || [];
				function gtag(){dataLayer.push(arguments);}
				gtag('js', new Date());

				gtag('config', 'G-65GZBP6TJ1');
			</script>
    {/literal}-->
    ...
    <style type="text/css">
        ...
        .pillNavbar__menu button.active {
            background-color: dodgerblue;
            color: white;
        }

        .pillNavbar__previous,
        .pillNavbar__next {
            display: none;
            position: absolute;
            top: 50%;
        ...
        #active-popup .popup-window.ready {
            position: fixed;
            top: 53%;
            left: 50%;
    ...
    <style>
        ...
        * {
        ...
        .tvvideo-container {
            --clr: #0948b3;
            background-image: linear-gradient(3deg, var(--clr), #eee, var(--clr)) !important;
...
<div id="popup" style="z-index: 9999999; display: none; position: absolute; top: 57%; left: 50%; transform: translate(-50%, -20%); background-color: white; padding: 70px;width: 90%;border-style: solid; border-width: thin; border-color: gray">
		  <div style="float: right;">
			<button onclick="document.getElementById('popup').style.display = 'none';">X</button>
		  </div>
		  <p><h2>7-Day Money-Back Guarantee</h2>
		<p>At Optimedia, we are committed to providing our customers with the best possible IPTV experience. That's why we offer a 7-day money-back guarantee on all of our IPTV packages for payments made with credit cards only.</p>
		...
		<ul>
		  ...
		  <li>E-Transfer and Bitcoin payments are Non-refundable </li>
...
{if $templatefile != 'canadahome'}
{$headeroutput}
</br>
	<div class="support-action d-inline-flex " style="text-align: center;">
	<!--	<a href="contact.php" class="mr-3" style="color:#000000"><i class="fas fa-comment mr-1 color-accent"></i> <span>Email Us</span></a>
		...
		<!--<a href="index.php?rp=/store/try-iptv" class="mb-0" style="color:#000000"><i class="fas fa-smile color-accent"></i> <span>Free Trials</span></a></br>-->
		<a href="index.php/store/choice-no-adult-packages" class="mb-0" style="color:#000000"><i class="fas fa-smile color-accent"></i> <span>Start Now</span></a>
		<a href="channel-list.php" class="mb-0" style="color:#000000"><i class="fas fa-list color-accent"></i> <span>Channel List</span></a>
		<a href="affiliates.php" class="mb-0" style="color:#000000"><i class="fas fa-dollar-sign"></i> <span>Affiliates</span></a>
		<a href="http://webtv.tel"  target=”_blank” class="mb-0" style="color:green"><i class="fas fa-tv color-accent"></i> <span>Watch Live TV</span></a></br>
        ...
        <div class="row">
            <section id="main-menu">
                <nav id="nav" class="navbar navbar-default navbar-main" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="primary-nav" style="border: none; margin-right:30%;width:80%">
                  <!--  <div class="collapse navbar-collapse" id="primary-nav" style="border: none;margin-right:10%">-->
...
<!--
    <section class="sticky-nav">
        <nav>
            <ul>
                <li><a href="index.php#iptv-apps">Plans Preview</a></li>
...
{if $templatefile == 'homepage'}
	...
	<section class="ptb-55" style="background-color:black !important;">
		<!--	<h2 style="text-align: center;"><span style="color: #ffffff;"><a style="color: #ffffff;" href="/index.php?rp=/store/">THE ULTIMATE TV EXPERIENCE AWAITS! ORDER NOW!</a></span></h2>-->
			<div style="text-align:center; padding:10px 0">
					<h2 style="display:inline; color:white;"><a style="color:white;" href="index.php/store/choice-no-adult-packages">Transform Your TV with Limitless Entertainment - Discover the Best in IPTV!</a></h2>
					<!--<h2 style="display:inline; color:white;"><a style="color:red;" href="index.php/store/choice-no-adult-packages">Black Friday & Cyber Monday Sales - Save 25% on all IPTV plans!</a></h2>-->
				</br>
				<h4 style="display:inline; color:white;"><a style="color:white;" href="/index.php/store/choice-no-adult-packages">Try IPTV Risk-Free with our 7-day Money-Back Guarantee.</a></h4>
				<button  onclick="document.getElementById('popup').style.display = 'inline';" style="background-color: black; color:white;">Read more</button>
			</div>
	</section>
	<!--Free iptv box image-->
	<section class="ptb-55" style="background-color:#00bf63 !important;">
	<div style="display: flex; justify-content: center;">
		<a href="https://optimedia.tv/store/android-iptv-box" style="display: flex; justify-content: center;">
			<img src="{$WEB_ROOT}/templates/{$template}/customfiles/assets/img/1year-iptv-deal.webp" alt="1 year iptv + free android box" style="max-width: 100%; height: auto;">
		</a>
	</div>	
	</section>

	<!--Free CHOICE HUB box image-->
		<section class="ptb-55" style="background-color:#d9d9d9 !important;">
			<div style="display:flex;justify-content: center;flex-direction: column;align-items: center">
				<h5 style="text-align: center; margin-top:20px">Choice Hub simplifies TV service management, offering seamless control at your fingertips! Explore our features:<br>Convenient invoice payment; <br>Effortless request for movies or TV series; <br>Seamless ordering of new IPTV services Available<br>Download URL: <a href="http://choicehub.eztv.cx" target="_blank">http://choicehub.eztv.cx</a><br>Google Playstore: <a href="https://play.google.com/store/apps/details?id=com.choiceiptv" target="_blank">Download Now</a></h5>
				<br>
				<p style="text-align: center;">
					<video controls="controls" width="549" height="309" style="max-width: 100%;" volume="0.5">
						<source src="https://www.dropbox.com/scl/fi/ol0k0gzdy8i70ns6tq5v4/choicehub4.mp4?rlkey=13vmttbobpbetmch9j2pav2ev&raw=1" type="video/mp4" /> Your browser does not support the video tag.
					</video>
				</p>
			</div>	
	</section>	
	 ...
	 <section class="promo-section pt-100" style="margin-top:-50px" >
        <div class="container" >
		<!--	<h5 style=" text-align: center;">Choice Hub simplifies TV service management, offering seamless control at your fingertips! Explore our features:.<br>Convenient invoice payment; <br>Effortless request for movies or TV series; <br>Seamless ordering of new IPTV services Available<br>Download url:<a href="http://choicehub.eztv.cx" target=”_blank”> http://choicehub.eztv.cx</a> <br>Google Playstore: <a href="https://play.google.com/store/apps/details?id=com.choiceiptv" target=”_blank”>Download Now</a></h5></br>
		<p style=" text-align: center;"><video controls="controls" width="549" height="309" style="max-width: 100%;" volume="0.5"><source src="https://www.dropbox.com/scl/fi/ol0k0gzdy8i70ns6tq5v4/choicehub4.mp4?rlkey=13vmttbobpbetmch9j2pav2ev&raw=1" type="video/mp4" /> Your browser does not support the video tag. </video></p>
-->
                    ...
                    <a id="btnOrderHosting" href="#subscribe">
                        <div class="single-promo-card single-promo-hover text-center">
                            <div class="promo-body">
                                ...
                                <div class="promo-info">
                                     <h5>SUBSCRIBE</h5>
                                     <p>Subscribe to Premium IPTV Now!</p>
                                </div>
                            </div>
                        </div>
                    </a>
                        ...
                        <div class="single-promo-card single-promo-hover text-center">
                            <div class="promo-body">
                                ...
                                <div class="promo-info">
                                    ...
                                    <p>Start your own IPTV Business!</p>
                                </div>
                            </div>
                        </div>
                    </a>
...
<iframe src="https://www.tvsportguide.com/widget/646ffd0f18fd1?heading=Events&border_color=blue&autoscroll=1" frameborder="0" style="width: 95%; height: 500px; border: none; margin: 0 auto"></iframe><p style="margin-top: 2px; font-size: 10px;">&copy; Sports on TV</p>   
 </div>
  </div> -->
  
    <section class="ptb-55 main-heading" style="background-color:#0948b3   !important;">
			<h2 style="text-align: center;"><span style="color: #ffffff;"><a style="color: #ffffff;" href="/affiliates-program.php">Become an Affiliate and earn 25% on referrals.</a></span></h2>
			<p style="color: #ffffff; text-align: center;"> <a style="color: #ffffff;" href="/affiliates-program.php">Click here to sign up as an affiliate and get paid for every referral that subscribe to one of our IPTV packages. Payouts are done through PayPal.</a></p> 	  
    </section>

<!--about section start-->
    <section class="about-section" style="background-color: #e1e2e3; padding: 40px 0;" id="features">
        <div class="container">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="cta-new-wrap">
                        ...
                        <div class="action-btns">
                            <a href="index.php/store/" class="btn outline-btn animated-btn mr-lg-3">Start Watching TV Now</a>
...
<!--about section start-->
			 ...
			 <div class="col-md-6 col-lg-6">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="cta-new-wrap">
                        ...
                        <div class="action-btns">
                            <a href="index.php/store/" class="btn outline-btn animated-btn mr-lg-3">Start Watching Sports Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-center-row">
                <div class="col-md-6 col-lg-6">
                 ...
                 <!--       </ul>
                        <div class="action-btns">
                            <a href="/index.php/store/vpn" class="btn outline-btn animated-btn mr-lg-3">Stop ISP Throttling & Start Watching TV Now</a>
    ...
    <section class="our-services gray-light-bg" style="padding: 40px 0;">
        <div class="container">
            <div class="row" style="display: flex; flex-wrap: wrap;">
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="choice-server.php" class="btn outline-btn mt-3" style="font-size:12px">Choice</a>
                        <a href="index.php/store/americas" class="btn outline-btn mt-3" style="font-size:12px">Americas</a>
                        <a href="cart.php?gid=40" class="btn outline-btn mt-3" style="font-size:12px">USA</a>
                        <a href="index.php/store/canada-premium-tv-no-adult" class="btn outline-btn mt-3" style="font-size:12px">Canada</a>
                        <a href="cart.php?gid=41" class="btn outline-btn mt-3" style="font-size:12px">English</a>
				    </div>
                </div>
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="index.php/store/" class="btn outline-btn mt-3" style="font-size:12px">STREAM TV SHOWS</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="index.php/store/" class="btn outline-btn mt-3" style="font-size:12px">STREAM VOD</a>
                ...
                <div class="col-md-6 col-lg-6b">
                    <div class="single-service rounded border white-bg">
                        ...
                        <a href="index.php/store/" class="btn outline-btn mt-3" style="font-size:12px">WATCH PREMIUM SPORTS</a>
                    </div>
                </div>
            </div>
        </div>
   ...
   <!--Reseller packages section start-->
    ...
    <section class="feature-section gray-light-bg" style="padding: 40px 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-6b">
...
<!--Customer reviews End-->
   ...
   <section class="primary-bg" id="terms-of-service">
    ...
    <!---Blog section Start--->
  <!--
    <section class="ptb-55 primary-bg" id="articles">
        <h2 class="text-white main-heading"><center>ARTICLES</center></h2>
    </section>
  
    {include file="$template/whmcmsblogs.tpl"}    
  -->
    <!---Blog section End--->
...
<section id="main-body" >
    {if !in_array($templatefile, ['login', 'clientregister', 'password-reset-container', 'logout'])}
    <div class="container{if $skipMainBodyContainer}-fluid without-padding{/if}" style="overflow-x:hidden">
        <div class="row">
...
<script> 
    window.addEventListener('load',e => {
        ...
        // #channelList-pillNav-container, #channelList-pillNav 
        function switchSetter (id,tvID = null) {

            const navbarMenu = document.querySelector(id + ' .pillNavbar__menu');

            if (navbarMenu) {


                const navbarNext = document.querySelector(id + ' .pillNavbar__next');
                const navbarPrevious = document.querySelector(id + ' .pillNavbar__previous');

                // ------------------------------------------------
                // STARTING MOVING FUNCTIONALITY
                // ------------------------------------------------

                let scrollPosition = 0;
                let moveSize = 150;
                let maxScroll = navbarMenu.scrollWidth - navbarMenu.clientWidth;

                navbarPrevious.addEventListener("click", () => {
                    scrollPosition = Math.max(scrollPosition - moveSize, 0);
                    navbarMenu.style.transform = 'translateX(-' + scrollPosition +'px)';
                });

                navbarNext.addEventListener("click", () => {
                    scrollPosition = Math.min(scrollPosition + moveSize, maxScroll);
                    navbarMenu.style.transform = 'translateX(-' + scrollPosition +'px)';
                });

                window.addEventListener("resize", () => {
                    maxScroll = navbarMenu.scrollWidth - navbarMenu.clientWidth;
                ...
                // ------------------------------------------------
                // ENDED MOVING FUNCTIONALITY
                // ------------------------------------------------

                // ------------------------------------------------
                // STARTING CHANGING DATA FUNCTIONALITY
                // ------------------------------------------------

                const pillNavBtns = navbarMenu.querySelectorAll('button');
                ...
                // ------------------------------------------------
                // ENDED CHANGING DATA FUNCTIONALITY
                // ------------------------------------------------
            }
        ...
        // top__pillNavbar
        switchSetter('#top__pillNavbar','#top-tv')
        // middle__pillNavbar
        switchSetter('#middle__pillNavbar','#middle-tv')
        // bottom__pillNavbar
        switchSetter('#bottom__pillNavbar','#bottom-tv')
        ...
        if(channelListPage) {
            switchSetter('#channelList-pillNav-container')
        }
 
        const magserversPage = document.querySelector('.magservers-page');
        if(magserversPage) {
            switchSetter('#magservers-pillNav-container')
        }
    })
</script>

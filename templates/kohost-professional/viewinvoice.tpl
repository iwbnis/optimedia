    ...
    <div class="container-fluid invoice-container">
        ...
        {else}
            ...
            <div class="pull-right btn-group btn-group-sm hidden-print">
                <a href="/submitticket.php?step=2&deptid=1" class="btn btn-default"><i class="far fa-life-ring"></i> Submit Ticket</a>			
...
//     if(selectedValue == 'coinbasecommerce'){
...
$(document).ready(function() {
  ...
  const selectedValue = $('.select-inline option:selected').val();
  if(selectedValue == 'xeropay'){
...
if(getUrlParameter("device") === 'choicehubApp' || window.navigator.userAgent == 'choicehubApp'){
	console.log(window.navigator.userAgent);
        $('.text-center.hidden-print').hide();
	$('.pull-right.btn-group.btn-group-sm.hidden-print').hide();
	$('.invoice-col').children('p').children('img').hide();
}
});
</script>

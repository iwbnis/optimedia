					...
					<div class="pill-nav-container" id="top-pillNav-container">
						<button class="move-btn prev-btn"><</button>
							<div class="pill-nav" id="top-pillNav">
								<button class="first-btn active" data-id="prime-tivimate">Tivimate</button>
								<button  data-id="prime-xciptv">XCIPTV</button>
								<button  data-id="prime-purple">Purple</button>
								<button  data-id="prime-smarters">IPTV Smarters</button>
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    <div class="hosting-promo-content">
                                        ...
                                        <a
                                            href="https://optimedia.tv/index.php/store/prime-server-plans"
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    <div class="hosting-promo-content">
                                        ...
                                        <p>
                                            Access over 1,000 movies and tv
                    ...
                    >
                        ...
                        <div class="col-md-7 col-lg-6 details">
                            <div class="feature-content-wrap">
                                <h2>
                                    Good IPTV Service for UK, Canada, USA & International IPTV. 
                                </h2>
								<h4 style="color:red">***Trials Disabled on Weekends****</h4>
                                <p>
...
<!--services section start-->
    ...
    <br/>
			<h2 class="text-white" id="channel-list"><center> Prime Server Channel Lineup</center></h2>	
    <br/>
    </section>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-12 col-lg-6 ">
                            ...
                            <div class="action-btns mt-4">
                                <a href="https://optimedia.tv/index.php/store/prime-server-plans" class="btn btn-brand-03">
                                    Order Prime IPTV Now
                                </a>
                            </div>
                        </div>

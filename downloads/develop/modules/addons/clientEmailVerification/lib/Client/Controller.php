...
namespace WHMCS\Module\Addon\CustomGeneralFields\Client;
...
class Controller {
    ...
    public function index($vars)
    {
        ...
        return array(
            ...
            'breadcrumb' => array(
                'index.php?m=CustomGeneralFields' => 'Sample Addon Module',
            ),
    ...
    public function secret($vars)
    {
        ...
        return array(
            ...
            'breadcrumb' => array(
                'index.php?m=CustomGeneralFields' => 'Sample Addon Module',
                'index.php?m=CustomGeneralFields&action=secret' => 'Secret Page',
            ),

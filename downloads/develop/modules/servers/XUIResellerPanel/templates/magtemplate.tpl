<link rel="stylesheet" type="text/css" href="modules/servers/XUIResellerPanel/templates/newstyle.css" />
    ...
    {if $status eq 'Active'}
        <div class="col-lg-9">
            <div class="panel panel-default panel-accent-green pannel_new_custom" style="height: 175px;">
                ...
                <div class="list-group-item">
                    <div width="100%">      
                        <div style="margin-right:10px;float: left;font-size: 14px;"> {if $engma eq 'yes'}{$lang.eng_desc}{else}{$lang.mag_desc}{/if} </div>  <div> 
                              <strong class="text-domain"><a target="_blank" href='{$mag_portal}/c/'>{$mag_portal}/c/ </a></strong>  
                        </div>
                    </div>  
                </div> 
                {if $mag !== "None"}
                    <div class="list-group">
                        <div class="list-group-item">
                            <div style="margin-right: 10px;float: left;font-size: 14px;">{if $engma eq 'yes'}{$lang.current_eng}{else}{$lang.current_mag}&nbsp;{/if} </div> <strong class="text-domain" style="font-size: 14px;">{$mag}</strong>
                        </div>  
                        <div class="list-group-item">
                            <div width="100%"> <div style="margin-right: 10px;float: left;margin-top: 8px;font-size: 14px;">{if $engma eq 'yes'}{$lang.new_eng}{else}{$lang.new_mag}&nbsp;{/if}</div>  <div><strong class="text-domain"> 
                                        <form method="post" class="macaddress" action="clientarea.php?action=productdetails&id={$serviceid}"> 
                                            ...
                                            <button style="width: 30%;" type="submit" class="btn btn-success btn-block"> 
                                                {if $engma eq 'yes'}{$lang.change_eng_button}{else}{$lang.change_mag_button}{/if}
                                            </button>
                                        </form></strong></div>
                            </div>  
                        </div>
                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            <div width="100%"> <div style="margin-right: 10px;float: left;margin-top: 8px;font-size: 14px;">{$lang.new_mag}&nbsp;&nbsp; {if $engma eq 'yes'}(Enigma2 Device){else}(MAG Device){/if}: </div>  <div><strong class="text-domain"> 
                                        <form method="post" class="macaddress" action="clientarea.php?action=productdetails"> 
                                            <input type="hidden" name="id"  value="{$serviceid}">
                                            <input class="form-control" style="width: 38%;float: left;margin-right: 15px;" maxlength="17" size="17" type="text" id="newMAC" name="newMAC" value="00:1A:79:xx:xx:xx" />

        ...
        <div class="list-group-item item_new"> 
            ...
            <div  width="100%" style="clear: both;margin-top: 12px;"> 
                <div style="width: 14%;float: left;margin-top: 8px;font-size: 14px;"><b>{$lang.playlist} :</b></div>  <div> 
                    <input style="width: 55%;float: left;margin-right: 15px;"  class="form-control" type="text" id="m3ulinks" value="{$m3uurl}/get.php?username={$iptv_username}&password={$iptv_password}&output={$outputfirst}&type=">
                    <a id="m3u_output" data-url="{$m3uurl}/get.php?username={$iptv_username}&password={$iptv_password}&output={$outputfirst}&type="  href='{$mag_portal}/get.php?username={$iptv_username}&password={$iptv_password}&output={$outputfirst}&type=' class="btn btn-default btn-primary">
            ...
            <div class="list-group-item">
                <div width="100%"> 
                    <div style="width: 18%;float: left;margin-top: 8px;font-size: 14px;">Enigma 2 OE 1.6 : </div>  <div>
                        <input style="width: 55%;float: left;margin-right: 15px;"  class="form-control" type="text" id="e2oe16" value="wget -O /etc/enigma2/iptv.sh '{$mag_portal}/get.php?username={$iptv_username}&password={$password}&type=enigma216_script&output={$outputfirst}' && chmod 777 /etc/enigma2/iptv.sh && /etc/enigma2/iptv.sh">
            ...
            <div class="list-group-item" class="form-inline"> 
                <div width="100%"> 
                    <div style="width: 18%;float: left;margin-top: 8px;font-size: 14px;">Enigma 2 OE 2.0 : </div>  <div>
                        <input style="width: 55%;float: left;margin-right: 15px;"  class="form-control" type="text" id="e2oe20" value="wget -O /etc/enigma2/iptv.sh '{$mag_portal}/get.php?username={$iptv_username}&password={$password}&type=enigma22_script&output={$outputfirst}' && chmod 777 /etc/enigma2/iptv.sh && /etc/enigma2/iptv.sh">
            ...
            <div class="list-group-item" class="form-inline"> 
                <div width="100%"> 
                    <div style="width: 18%;float: left;margin-top: 8px;font-size: 14px;">Octagon Script : </div>  <div>
                        <input style="width: 55%;float: left;margin-right: 15px;"  class="form-control" type="text" id="octagon" value="wget -qO /var/bin/iptv '{$mag_portal}/get.php?username={$iptv_username}&password={$password}&type=octagon_script&output={$outputfirst}'">

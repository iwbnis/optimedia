<link rel="stylesheet" type="text/css" href="modules/servers/NXTbyKak/templates/newstyle.css" />
        ...
        <div class="list-group-item item_new"> 
            ...
            <div  width="100%" style="clear: both;margin-top: 12px;"> 
                <div class="list_itm_here_new" style="width: 14%;float: left;margin-top: 8px;font-size: 14px;"><b>{$lang.playlist} :</b></div>  <div> 
                    ...
                    <button class="btn btnclipboard new_btn_custom" style="width: 10%;" id="M3UPlaylistid" data-clipboard-target="#m3ulinks"><img src="modules/servers/NXTbyKak/templates/image/copy-button.png"></button>
                </div>
            </div>  
        </div> 
                    ...
                    <div class="list-group-item">
                        <div width="100%"> 
                            ...
                            <div>
                                ...
                                <button class="btn btnclipboard" style="width: 10%;" id="EQGis{$customcount}" data-clipboard-target="#custominputid{$customcount}"><img src="modules/servers/NXTbyKak/templates/image/copy-button.png" /></button>
                            </div>
                        </div> 
                    </div>
...
<script>
                        ...
                        $(".btnclipboard").click(function () {
                            ...
                            clipboard.on('success', function (e) {
                                $('.btnclipboard').html('<img src="modules/servers/NXTbyKak/templates/image/copy-button.png" />');
                                $('#' + id).html('Copied!');
                            });

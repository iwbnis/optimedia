<div class="content-container">
    ...
    <form method="post" action="#" role="form">
        ...
        <div class="action-buttons">
            <button name="userAuthorization" id="userAuthorizationAccepted" value="yes" type="submit" class="btn primary-solid-btn">
                {lang key='oauth.authorise'}
            </button>
            <button name="userAuthorization" id="userAuthorizationDeclined" value="no" type="submit" class="btn outline-btn">
                {lang key='cancel'}
            </button>
        </div>
    </form>

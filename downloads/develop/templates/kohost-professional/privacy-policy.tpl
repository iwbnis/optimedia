...
<head>
    ...
    <div class="main">
        ...
        <section class="privacy-policy ptb-100" style="margin-top:-100px">
            <div class="container">
                <div class="row">
                        ...
                        <div class="content-with-sidebar">
                            ...
                            <div id="nav-id-2" class="pt-5">
                                ...
                                <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
                                    ...
                                    the visibility associated with the hyperlink outweighs the absence of Kohost; and (d) where the
                                ...
                                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
                                    you must notify us by sending an e-mail to <a href="mailto:name@yourdomain.com" title="send an email to name@yourdomain.com">name@yourdomain.com</a>.
                                ...
                                <p>No use of Kohost's logo or other artwork will be allowed for linking absent a trademark license
                                    agreement.</p>
                            </div>
                            ...
                            <div id="nav-id-3" class="pt-5">
                                ...
                                <p>We provide information to help copyright holders manage their intellectual property online. If you think somebody is violating your copyrights and want to notify us, you can find information about submitting notices and Front's policy about responding to notices in our

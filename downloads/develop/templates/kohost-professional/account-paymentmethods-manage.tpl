...
<div class="custom-card-block">
    ...
    <div class="fieldgroup-auxfields{if $remoteUpdate} hidden{/if}">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="inputDescription" name="description" autocomplete="off" value="{$payMethod->description}" style="display:inline-block;">
            ...
            {if $creditCardCvcFieldEnabled}
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <button id="cvvWhereLink" type="button"  data-toggle="popover" class="renew-alert" data-placement="right" data-content="<img src='{$BASE_PATH_IMG}/ccv.gif' width='210'>">
    ...
    <div class="fieldgroup-auxfields{if $remoteUpdate} hidden{/if}">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                ...
                <a href="#" class="add-new-address" data-toggle="modal" data-target="#modalBillingAddress"><i class="fas fa-plus-circle"></i> {$LANG.paymentMethodsManage.addNewAddress}</a>
            </div>
        </div>
        <div class="form-group submit-container">
            <div class="col-sm-8 col-sm-offset-4">
                <button type="submit" name="submit" id="btnSubmit" class="btn primary-solid-btn">{$LANG.clientareasavechanges}</button>
                <a href="{routePath('account-paymentmethods')}" class="btn outline-btn">{$LANG.cancel}</a>
            </div>
        </div>
    </div>

<form method="post" action="clientarea.php?action=masspay" class="form-horizontal">
    ...
    <table class="table mass-pay-table">
        <thead>
            <tr>
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="panel-title mb-5">{$LANG.masspaymentselectgateway}</h3>
        </div>
        <div class="col-md-8">
         ...
         <div class="col-md-4">
           <input type="submit" value="{$LANG.masspaymakepayment}" class="btn primary-solid-btn btn-block" id="btnMassPayMakePayment" />
        </div>
    </div>

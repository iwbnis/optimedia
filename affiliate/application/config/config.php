...
|
*/
$config['base_url']  = 'https://optimedia.tv/affiliate';/*
/*
/*
|--------------------------------------------------------------------------
| Modules locations
...
$final = $HTTPSurl . '://' .str_replace(array('https://','http://'), array('',''), $config['base_url'] );
$config['base_url'] = $final;
$root = "{$HTTPSurl}://".$_SERVER['HTTP_HOST'];
...
|
*/
$config['encryption_key'] = '3454GFDFGG435FFGH&&%9)&565jkj&&&%J';
/*
|--------------------------------------------------------------------------
| Session Variables
|--------------------------------------------------------------------------

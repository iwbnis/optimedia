...
class Store_Category extends REST_Controller {
    ...
    public function get_store_category_get()
    {
        ...
        {
            $data = $this->Common->get_data_all_desc('categories', $where = array(), 'id,name', 'id');
            $response = array(
                'status' => TRUE,

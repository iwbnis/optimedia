    ...
    <div class="col-12">
        <form id="form_form">
            <div class="row">
                                            ...
                                            <small class="text-muted">
                                                <?php
                                                    if($setting['form_recursion'] == 'custom_time'){
                                                        ...
                                                        echo __('admin.default_recursion')." : " . $setting['product_recursion']. " | ".__('admin.endtime')." : " . dateFormat($setting['recursion_endtime']);
                                                    }
                                                ?>
                                            </small>
                                        </div>
                ...
                <div class="col-sm-4">
                    <div class="card mb-3">
                        <div class="card-header"><h4 class="header-title m-0"><?= __('admin.commission_settings') ?></h4></div>
                        <div class="card-body">
                            <fieldset class="custom-design mb-2">
                    ...
                    <div class="mt-2">
                        <div class="text-right">
                            ...
                            <button type="button" rtype='save_stay' class="btn btn-lg btn-default btn-submit btn-success" name="save"><?= __('admin.save') ?></button>
                            <button type="button" rtype='' class="btn btn-lg btn-default btn-submit btn-success" name="save"><?= __('admin.save_close') ?></button>
                        </div>
                    </div>
                </div>
            </div>

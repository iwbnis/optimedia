						...
						<div class="table-rep-plugin">
							...
							<?php if($product_count == 0){ ?>
								<div class="alert alert-danger">
									<strong><?= __('admin.admin_product') ?>: </strong> <?= __('admin.you_need_to_create_product') ?> <a href="<?= base_url('admincontrol/addproduct') ?>"><?= __('admin.create_first_product') ?>t</a>
								</div>
							<?php } ?>
                        	...
                        	<?php } else { ?>
								<div class="table-responsive b-0" data-pattern="priority-columns">save_exit
											...
											<tbody>
												...
												<?php foreach($forms as $form){ ?>
													<tr>
														...
														<td>
															<span class="btn btn-sm btn-primary" data-social-share data-share-url="<?= $form['public_page'] ?>" data-share-title="" data-share-desc=""><i class="fa fa-share-alt" aria-hidden="true"></i></span>

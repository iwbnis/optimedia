                ...
                <form>
                    <div class="form-content">
                        ...
                        <div class="form-group">
                            <label>
                                <?= __('admin.jump_level') ?>
                                <span class="field-description" data-toggle="tooltip" title="<?= __('admin.award_level_jump_level_desc') ?>"></span>
                                <span class="field-description default-level-description d-none" data-toggle="tooltip" title="<?= __('admin.award_level_jump_default_level_desc') ?>"></span>
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" class="form-control" name="default_registration_level" value="1">
                            <p class="error-message"></p>
                        </div>
                    </div>

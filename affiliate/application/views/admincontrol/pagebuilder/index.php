							...
							<tbody>
								<?php foreach($pagebuilder_themes as $themes){ ?>
									<tr>
										...
										<td class="txt-cntr">
											<a class="btn btn-sm btn-primary" onclick="return confirm(<?= __('admin.are_you_sure_to_edit') ?>);" href="<?php echo base_url();?>pagebuilder/addtheme/<?php echo $themes['theme_id'];?>"><i class="fa fa-edit cursors" aria-hidden="true"></i></a>

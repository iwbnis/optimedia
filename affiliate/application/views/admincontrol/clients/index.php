                            ...
                            <tbody>
                                <?php foreach($clientslist as $clients){ ?>
                                    <tr>
                                        ...
                                        <td class="txt-cntr"> 
                                            <a class="btn btn-danger" onclick="return confirm(<?= __('admin.lost_all_data_are_you_sure_delete') ?>);" href="<?php echo base_url();?>admincontrol/deleteusers/<?php echo $clients['id'];?>/client"><i class="fa  fa-trash-o cursors" aria-hidden="true" style="color:#ffffff"></i></a> 

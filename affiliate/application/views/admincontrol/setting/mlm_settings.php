						...
						<div class="tab-content">
							...
							<div class="form-group">
								...
								<div class="radio-group">
									...
									<label class="radio radio-inline"><input type="radio" class="referlevel_status" <?= (int)$referlevel['status'] == 
										2 ? 'checked' : '' ?> name="referlevel[status]" value="2" > <?= __('admin.disable_only_for_selected_users') ?> </label>
								</div>

								<div class="div-toggle status-1">
									<div class="well">
										<div class="m-0 alert alert-info"><?= __('admin.enable_for_all_users') ?></div>
									</div>
								</div>
								<div class="div-toggle status-0">
									<div class="well">
										<div class="m-0 alert alert-info"><?= __('admin.disable_for_all_users') ?></div>
									</div>
								</div>
								<div class="div-toggle status-2">
									<div class="well">
										<div class="alert alert-info"><?= __('admin.disable_only_for_selected_users') ?></div>
										<?php

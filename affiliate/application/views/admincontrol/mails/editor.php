								...
								<div class="tab-content">
									<?php if($allows['user'][$templates['id']]){ ?>
										<div role="tabpanel" class="tab-pane active" id="for-user">
											...
											<div class="form-group">
												<label for=""><?= __('admin.subject') ?></label>
												<textarea id="editor1" type="text" class="form-control" name="text" ><?php echo $templates['text'] ?></textarea>
											</div>
										</div>
									<?php } ?>
									<?php if($allows['admin'][$templates['id']]){ ?>
										<div role="tabpanel" class="tab-pane" id="for-admin">
											...
											<div class="form-group">
												<label for=""><?= __('admin.subject') ?></label>
												<textarea id="editor2" type="text" class="form-control" name="admin_text" ><?php echo $templates['admin_text'] ?></textarea>
											</div>
										</div>
									<?php } ?>
									<?php if($allows['client'][$templates['id']]){ ?>
										<div role="tabpanel" class="tab-pane" id="for-client">
											...
											<div class="form-group">
												<label for=""><?= __('admin.subject') ?></label>
												<textarea id="editor3" type="text" class="form-control" name="client_text" ><?php echo $templates['client_text'] ?></textarea>
											</div>
										</div>
									<?php } ?>
								</div>

	...
	<div class="col-sm-6">
		...
		<div class="card mb-2">
			...
			<div class="card-header">
				...
				<h5 class="card-title m-0"><?= __('admin.purchase_details') ?></h5>
			...
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item"><b><?= __('admin.type') ?>:</b> <?= ($plan->plan ? $plan->plan->type : '') ?></li>

				<li class="list-group-item"><b><?= __('admin.is_active') ?>:</b> <?= $plan->active_text ?></li>

				<li class="list-group-item"><b><?= __('admin.status') ?>:</b> <?= $plan->status_text ?></li>
		...
		<div class="card mb-2">
			...
			<div class="card-header">
				...
				<h5 class="card-title m-0"><?= __('admin.edit_plan') ?></h5>
	...
	<div class="col-sm-6">
		...
		<div class="card">
			...
			<div class="card-header">
				...
				<h5 class="card-title m-0"><?= __('admin.plan_details') ?></h5>
    		...
    		<ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><b><?= __('admin.type') ?>:</b> <?= $plan->plan->type ?></li>

                <li class="list-group-item"><b><?= __('admin.price') ?>:</b> <?= $plan->plan->price ?></li>
		...
		<div class="card mt-3">
			...
			<div class="card-header">
				...
				<h5 class="card-title m-0"><?= __('admin.status_history') ?></h5>

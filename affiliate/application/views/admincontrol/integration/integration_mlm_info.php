                            ...
                            <?php if(!$tool['vendor_id']): ?>
                                <th style="vertical-align: top; border-right: 1px solid lightgrey; text-align: center;">
                                    ...
                                    <?php if ($tool['commission_type'] == 'default'): ?>
                                         <span class="form-control reg_comission_custom_amt"><?php echo isset($tool['referlevel']['reg_comission_custom_amt']) ? $tool['referlevel']['reg_comission_custom_amt'] : 0;?></span>
                                    <?php endif ?>
                                </th>
                            <?php endif ?>
                            <th style="vertical-align: top; border-right: 1px solid lightgrey; text-align: center;">

...
function snappycheckoutpremium_MetaData()
{
	return ['DisplayName' => 'Snappy Checkout Gateway premium', 'APIVersion' => '1.1', 'DisableLocalCreditCardInput' => true, 'TokenisedStorage' => false];
}

function snappycheckoutpremium_config()
{
	global $CONFIG;
	$URL = $CONFIG['SystemURL'];
	return [
		'FriendlyName' => ['Type' => 'System', 'Value' => 'SnappyCheckout Gateway premium'],
...
function snappycheckoutpremium_link($params)
{
	...
	$LicenseStatus = snappycheckoutpremium_verify_license();
...
function snappycheckoutpremium_verify_license()
{
	...
	$LicenseStatus = snappycheckoutpremium_curl_get_contents($url);
...
function snappycheckoutpremium_curl_get_contents($url)
{
	$ch = curl_init();

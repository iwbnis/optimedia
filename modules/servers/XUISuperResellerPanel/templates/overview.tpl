<link rel="stylesheet" type="text/css" href="modules/servers/XUIResellerPanel/templates/newstyle.css?v=665655551" />
...
<div style="width: 100%;" class="container">
    <div class="row">
        <div class="col-sm-12">
            {if $status eq 'Active'}
            <p class="new_p">Your online WebTV Player to watch your HD Channels &amp; VOD
...
<div class="modal fade" id="applicationpopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style=" float: left;font-size:22px " id="exampleModalLongTitle">Choose Your
                    Platform</h5>

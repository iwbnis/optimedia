<link rel="stylesheet" type="text/css" href="modules/servers/XUIResellerPanel/templates/newstyle.css?v=vvvvvvvvvv" />
...
{/if}
{if $macUpdatedStatus == 0}
    <div class="alert alert-danger" id="alertUnpaidInvoice"> 
        {$macUpdatedMessage}
    </div>
{/if}
<div class="tab-content margin-bottom">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="product-status product-status-{$rawstatus|strtolower}">
                        <div style="background: aliceblue;" class="product-icon text-center">
    ...
    <div class="row">
        {if $status eq 'Active'}
        <div class="col-lg-9">
            <div class="panel panel-default panel-accent-green pannel_new_custom" style="height: 260px;">
                <div class="panel-heading heading_new">
                    <h3 class="panel-title">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <div width="100%">
                            <div style="margin-right: 10px;float: left;margin-top: 8px;font-size: 14px;">{if $engma eq
                                'yes'}{$lang.new_eng}{else}{$lang.new_mag}&nbsp;{/if}</div>
                            <div><strong class="text-domain">
                                    <form method="post" id="macaddressForm" class="macaddress"
                                        ...
                                        <input type="hidden" name="customAction"
                                            value="{if $engma eq 'yes'}changeENG{else}changeMAG{/if}" />
                                        <input type="hidden" id="clientSelectedBouquets1" name="clientSelectedBouquets" value="">
                                        <button style="width: 30%;" id="save_pass" type="submit" class="btn btn-success btn-block">
                                            {if $engma eq
                                            'yes'}{$lang.change_eng_button}{else}{$lang.change_mag_button}{/if}
                                        </button>
                                    </form>
                                </strong></div>
                        </div>
    ...
    <div class="welcome_button clearfix">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 welcome_sub_btn welcome_sub_btn2">
                <a href="upgrade.php?type=package&id={$serviceid}">

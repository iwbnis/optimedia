...
namespace EdgeHosting\GuzzleHttp;

use EdgeHosting\GuzzleHttp\Cookie\CookieJarInterface;
...
use EdgeHosting\Psr\Log\LoggerInterface;
/**
        ...
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('EdgeHosting\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }

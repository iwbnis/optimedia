 ...
 */
namespace EdgeHosting\League\OAuth2\Client\Grant;

use EdgeHosting\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
/**
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'EdgeHosting\\League\\OAuth2\\Client\\Grant\\' . $class;

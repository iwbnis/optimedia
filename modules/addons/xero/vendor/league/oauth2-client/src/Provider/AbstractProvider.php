 ...
 */
namespace EdgeHosting\League\OAuth2\Client\Provider;

use EdgeHosting\GuzzleHttp\Client as HttpClient;
use EdgeHosting\GuzzleHttp\ClientInterface as HttpClientInterface;
use EdgeHosting\GuzzleHttp\Exception\BadResponseException;
use InvalidArgumentException;
use EdgeHosting\League\OAuth2\Client\Grant\AbstractGrant;
use EdgeHosting\League\OAuth2\Client\Grant\GrantFactory;
use EdgeHosting\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use EdgeHosting\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
use EdgeHosting\League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use EdgeHosting\League\OAuth2\Client\Token\AccessToken;
use EdgeHosting\League\OAuth2\Client\Token\AccessTokenInterface;
use EdgeHosting\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use EdgeHosting\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use EdgeHosting\League\OAuth2\Client\Tool\QueryBuilderTrait;
use EdgeHosting\League\OAuth2\Client\Tool\RequestFactory;
use EdgeHosting\Psr\Http\Message\RequestInterface;

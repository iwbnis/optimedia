 ...
 */
namespace EdgeHosting\Composer;

use EdgeHosting\Composer\Autoload\ClassLoader;
use EdgeHosting\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('EdgeHosting\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();

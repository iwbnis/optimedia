...
abstract class Report extends Remote\Model
{
    ...
    {
        return ['ReportID' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReportName' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReportType' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReportTitles' => [\true, self::PROPERTY_TYPE_STRING, null, \true, \false], 'ReportDate' => [\true, self::PROPERTY_TYPE_DATE, null, \false, \false], 'UpdatedDateUTC' => [\true, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'Rows' => [\true, self::PROPERTY_TYPE_STRING, null, \true, \false]];
    }

...
class MailingAddress extends Remote\Model
{
    ...
    {
        return ['StreetAddress' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SuiteOrAptOrUnit' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'City' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'State' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Zip' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Lattitude' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Longitude' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

...
class LineItem extends Remote\Model
{
    ...
    {
        return ['LineItemID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Description' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Quantity' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'UnitAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'ItemCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TaxType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'TaxAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'LineAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Tracking' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\TrackingCategory', \true, \false], 'DiscountRate' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'DiscountAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'RepeatingInvoiceID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

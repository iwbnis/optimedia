...
class Timesheet extends Remote\Model
{
    ...
    {
        return ['EmployeeID' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'StartDate' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'EndDate' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'TimesheetLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Timesheet\\TimesheetLine', \true, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'TimesheetID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Hours' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

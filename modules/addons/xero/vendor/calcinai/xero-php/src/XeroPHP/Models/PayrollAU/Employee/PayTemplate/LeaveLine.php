...
class LeaveLine extends Remote\Model
{
    ...
    {
        return ['LeaveTypeID' => [\false, self::PROPERTY_TYPE_GUID, null, \false, \false], 'CalculationType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'EntitlementFinalPayPayoutType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'AnnualNumberOfUnits' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'FullTimeNumberOfUnitsPerPeriod' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'NumberOfUnits' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

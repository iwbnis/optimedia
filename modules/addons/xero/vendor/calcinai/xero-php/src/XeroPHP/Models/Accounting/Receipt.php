...
class Receipt extends Remote\Model
{
    ...
    {
        return ['Date' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Contact' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Contact', \false, \false], 'LineItems' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\LineItem', \true, \false], 'User' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\User', \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LineAmountTypes' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'SubTotal' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalTax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Total' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'ReceiptID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReceiptNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'HasAttachments' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'Url' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }
     ...
     * @return Receipt
     */
    public function setUser(\XeroPHP\Models\Accounting\User $value)
    {

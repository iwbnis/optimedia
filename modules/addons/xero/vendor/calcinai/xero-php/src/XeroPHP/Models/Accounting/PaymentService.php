...
class PaymentService extends Remote\Model
{
    ...
    {
        return ['PaymentServiceID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaymentServiceName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaymentServiceUrl' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayNowText' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaymentServiceType' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }
     ...
     * @return PaymentService
     */
    public function addLineItem(\XeroPHP\Models\Accounting\LineItem $value)
    {

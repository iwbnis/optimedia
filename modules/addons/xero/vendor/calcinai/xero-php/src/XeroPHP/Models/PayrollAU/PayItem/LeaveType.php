...
class LeaveType extends Remote\Model
{
    ...
    {
        return ['Name' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TypeOfUnits' => [\true, self::PROPERTY_TYPE_STRING, null, \true, \false], 'IsPaidLeave' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ShowOnPayslip' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LeaveTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'NormalEntitlement' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LeaveLoadingRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'CurrentRecord' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false]];
    }

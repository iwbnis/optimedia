...
class Paystub extends Remote\Model
{
    ...
    {
        return ['EmployeeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaystubID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayRunID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FirstName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastEdited' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Earnings' => [\false, self::PROPERTY_TYPE_FLOAT, null, \true, \false], 'Deductions' => [\false, self::PROPERTY_TYPE_FLOAT, null, \true, \false], 'Tax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Reimbursements' => [\false, self::PROPERTY_TYPE_FLOAT, null, \true, \false], 'NetPay' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'EarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\EarningsLine', \true, \false], 'LeaveEarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\LeaveEarningsLine', \true, \false], 'TimesheetEarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\TimesheetEarningsLine', \true, \false], 'DeductionLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\DeductionLine', \true, \false], 'ReimbursementLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\ReimbursementLine', \true, \false], 'BenefitLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\BenefitLine', \true, \false], 'TimeOffLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\TimeOffLine', \true, \false]];
    }

...
class Employee extends Remote\Model
{
    ...
    {
        return [Remote\Request::METHOD_POST, Remote\Request::METHOD_GET];
    }
    /**
    ...
    {
        return ['FirstName' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastName' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'DateOfBirth' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'HomeAddress' => [\true, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\HomeAddress', \false, \false], 'StartDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Title' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'MiddleNames' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Email' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Gender' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Mobile' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Phone' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TwitterUserName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'IsAuthorisedToApproveLeave' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'IsAuthorisedToApproveTimesheets' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'Occupation' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'JobTitle' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Classification' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'OrdinaryEarningsRateID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayrollCalendarID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmployeeGroupName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BankAccounts' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\BankAccount', \true, \false], 'PayTemplate' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\PayTemplate', \false, \false], 'OpeningBalances' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\OpeningBalance', \true, \false], 'LeaveBalances' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\LeaveBalance', \true, \false], 'SuperMemberships' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\SuperMembership', \true, \false], 'TerminationDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'TerminationReason' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmployeeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'TaxDeclaration' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\TaxDeclaration', \false, \false]];
    }

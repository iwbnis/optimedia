...
class User extends Remote\Model
{
    ...
    {
        return ['UserID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmailAddress' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FirstName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'IsSubscriber' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'OrganisationRole' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false]];
    }

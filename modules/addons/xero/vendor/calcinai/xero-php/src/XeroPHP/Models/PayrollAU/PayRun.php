...
class PayRun extends Remote\Model
{
    ...
    {
        return ['PayrollCalendarID' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayRunID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayRunPeriodStartDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PayRunPeriodEndDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PayRunStatus' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'PaymentDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PayslipMessage' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Payslips' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip', \true, \false], 'Wages' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Deductions' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Tax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Super' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Reimbursement' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'NetPay' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

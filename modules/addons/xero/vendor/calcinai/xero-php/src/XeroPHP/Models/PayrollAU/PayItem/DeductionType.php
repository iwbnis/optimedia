...
class DeductionType extends Remote\Model
{
    ...
    {
        return ['Name' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReducesTax' => [\true, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'ReducesSuper' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'DeductionTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrentRecord' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false]];
    }

...
class OpeningBalance extends Remote\Model
{
    ...
    {
        return ['OpeningBalanceDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Tax' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\EarningsLine', \true, \false], 'DeductionLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\DeductionLine', \true, \false], 'SuperLines' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReimbursementLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\ReimbursementLine', \true, \false], 'LeaveLines' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EarningsRateID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Amount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'DeductionTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SuperMembershipID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CalculationType' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReimbursementTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LeaveTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'NumberOfUnits' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

...
class JournalLine extends Remote\Model
{
    ...
    {
        return ['JournalLineID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'AccountName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Description' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'NetAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'GrossAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TaxAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TaxType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'TaxName' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\TaxRate', \false, \false], 'TrackingCategories' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\TrackingCategory', \true, \false]];
    }

...
class Quote extends Remote\Model
{
    ...
    {
        return ['Contact' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Contact', \false, \false], 'Date' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'ExpiryDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'LineAmountTypes' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'LineItems' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\LineItem', \true, \false], 'SubTotal' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalTax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Total' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalDiscount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'CurrencyCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'QuoteID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'QuoteNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BrandingThemeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Title' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Summary' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Terms' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Url' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

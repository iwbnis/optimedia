...
class Setting extends Remote\Model
{
    ...
    {
        return ['Accounts' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Setting\\Account', \true, \false], 'TrackingCategories' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Setting\\TrackingCategory', \true, \false], 'DaysInPayrollYear' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

...
class PayRun extends Remote\Model
{
    ...
    {
        return ['PayScheduleID' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayRunPeriodEndDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PayRunStatus' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'PayRunID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayRunPeriodStartDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PaymentDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Earnings' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Deductions' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Reimbursement' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'NetPay' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'UpdateDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'PayStubs' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

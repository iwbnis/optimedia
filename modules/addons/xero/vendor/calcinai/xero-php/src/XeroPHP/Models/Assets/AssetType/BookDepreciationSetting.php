...
class BookDepreciationSetting extends Remote\Model
{
    ...
    {
        return ['depreciationMethod' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'averagingMethod' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'depreciationRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'effectiveLifeYears' => [\false, self::PROPERTY_TYPE_FLOAT, null, \true, \false], 'depreciationCalculationMethod' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

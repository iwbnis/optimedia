...
class LinkedTransaction extends Remote\Model
{
    ...
    {
        return [Remote\Request::METHOD_GET, Remote\Request::METHOD_PUT, Remote\Request::METHOD_POST, Remote\Request::METHOD_DELETE];
    }
    /**
    ...
    {
        return ['SourceTransactionID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SourceLineItemID' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ContactID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TargetTransactionID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TargetLineItemID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LinkedTransactionID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Type' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'SourceTransactionTypeCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

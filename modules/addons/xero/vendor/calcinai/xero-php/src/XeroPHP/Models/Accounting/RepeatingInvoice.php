...
class RepeatingInvoice extends Remote\Model
{
    ...
    {
        return ['Type' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Contact' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Contact', \false, \false], 'Schedule' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\RepeatingInvoice\\Schedule', \false, \false], 'LineItems' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\LineItem', \true, \false], 'LineAmountTypes' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BrandingThemeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'SubTotal' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalTax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Total' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'RepeatingInvoiceID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'HasAttachments' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false]];
    }

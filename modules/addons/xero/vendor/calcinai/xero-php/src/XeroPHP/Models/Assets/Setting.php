...
class Setting extends Remote\Model
{
    ...
    {
        return ['assetNumberPrefix' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'assetNumberSequence' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'assetStartDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'lastDepreciationDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'defaultGainOnDisposalAccountId' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'defaultLossOnDisposalAccountId' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'defaultCapitalGainOnDisposalAccount' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'optInForTax' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

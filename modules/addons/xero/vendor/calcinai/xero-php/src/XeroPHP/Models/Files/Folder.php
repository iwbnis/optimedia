...
class Folder extends Remote\Model
{
    ...
    {
        return ['Name' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FileCount' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Email' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'IsInbox' => [\true, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'Id' => [\true, self::PROPERTY_TYPE_GUID, null, \false, \false], 'Files' => [\true, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\Files\\File', \true, \false], 'FolderId' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }
     ...
     * @return Folder
     */
    public function addFile(\XeroPHP\Models\Files\File $value)
    {

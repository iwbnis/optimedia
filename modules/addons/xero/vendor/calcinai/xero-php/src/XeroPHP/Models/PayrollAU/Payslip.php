...
class Payslip extends Remote\Model
{
    ...
    {
        return ['EmployeeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayslipID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayRunID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\EarningsLine', \true, \false], 'TimesheetEarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\TimesheetEarningsLine', \true, \false], 'DeductionLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\DeductionLine', \true, \false], 'LeaveAccrualLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\LeaveAccrualLine', \true, \false], 'ReimbursementLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\ReimbursementLine', \true, \false], 'SuperannuationLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\SuperannuationLine', \true, \false], 'TaxLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\TaxLine', \true, \false], 'FirstName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmployeeGroup' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastEdited' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Wages' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Deductions' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'NetPay' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Tax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Super' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Reimbursements' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'LeaveEarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Payslip\\LeaveEarningsLine', \true, \false]];
    }

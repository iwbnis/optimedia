...
class EarningsType extends Remote\Model
{
    ...
    {
        return ['EarningsType' => [\true, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\EarningsType', \false, \false], 'DisplayName' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ExpenseAccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EarningsCategory' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'RateType' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'TypeOfUnits' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'EarningsRateID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EarningsTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Multiple' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'DoNotAccrueTimeOff' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'IsSupplemental' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Amount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

...
class LeavePeriod extends Remote\Model
{
    ...
    {
        return ['NumberOfUnits' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PayPeriodEndDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PayPeriodStartDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'LeavePeriodStatus' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false]];
    }

...
class BankTransaction extends Remote\Model
{
    ...
    {
        return ['Type' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Contact' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Contact', \false, \false], 'LineItems' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\LineItem', \true, \false], 'BankAccount' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\BankTransaction\\BankAccount', \false, \false], 'IsReconciled' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'Date' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Url' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'LineAmountTypes' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'SubTotal' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalTax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Total' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'BankTransactionID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PrepaymentID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'OverpaymentID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'HasAttachments' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false]];
    }

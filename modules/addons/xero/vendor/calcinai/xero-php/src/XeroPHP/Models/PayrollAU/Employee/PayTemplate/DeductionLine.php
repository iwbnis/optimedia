...
class DeductionLine extends Remote\Model
{
    ...
    {
        return ['DeductionTypeID' => [\false, self::PROPERTY_TYPE_GUID, null, \false, \false], 'CalculationType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Percentage' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Amount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

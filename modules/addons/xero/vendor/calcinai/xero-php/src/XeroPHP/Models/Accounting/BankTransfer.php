...
class BankTransfer extends Remote\Model
{
    ...
    {
        return ['FromBankAccount' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\BankTransfer\\FromBankAccount', \false, \false], 'ToBankAccount' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\BankTransfer\\ToBankAccount', \false, \false], 'Amount' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Date' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'BankTransferID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'FromBankTransactionID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ToBankTransactionID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FromIsReconciled' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'ToIsReconciled' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'HasAttachments' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'CreatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false]];
    }

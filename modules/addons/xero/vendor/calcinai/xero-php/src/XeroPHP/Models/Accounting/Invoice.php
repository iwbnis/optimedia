...
class Invoice extends Remote\Model
{
    ...
    {
        return [Remote\Request::METHOD_GET, Remote\Request::METHOD_PUT, Remote\Request::METHOD_POST];
    }
    /**
    ...
    {
        return ['Type' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Contact' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Contact', \false, \false], 'LineItems' => [\true, self::PROPERTY_TYPE_OBJECT, 'Accounting\\LineItem', \true, \false], 'Date' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'DueDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'LineAmountTypes' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'InvoiceNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BrandingThemeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Url' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'SentToContact' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'ExpectedPaymentDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PlannedPaymentDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'SubTotal' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalTax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Total' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalDiscount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'InvoiceID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'RepeatingInvoiceID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'HasAttachments' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'Payments' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Payment', \true, \false], 'Prepayments' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Prepayment', \true, \false], 'Overpayments' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Overpayment', \true, \false], 'AmountDue' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'AmountPaid' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'FullyPaidOnDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'AmountCredited' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'CreditNotes' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\CreditNote', \true, \false]];
    }
     ...
     * @return Invoice
     */
    public function setContact(\XeroPHP\Models\Accounting\Contact $value)
    {
    ...
    public function getOnlineInvoiceUrl()
    {
        ...
        return $this->onlineInvoiceRequest()->send()->getElements()[0]['OnlineInvoiceUrl'];
    }
    /**
    ...
    {
        return new Remote\Request($this->_application, $this->onlineInvoiceRemoteUrl());
    }
    /**
    ...
    {
        return new Remote\URL($this->_application, 'Invoices/' . $this->getGUID() . '/OnlineInvoice');
    }
}

...
class SuperannuationLine extends Remote\Model
{
    ...
    {
        return ['SuperMembershipID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ContributionType' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CalculationType' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'MinimumMonthlyEarnings' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ExpenseAccountCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LiabilityAccountCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaymentDateForThisPeriod' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Percentage' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Amount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

...
class WorkLocation extends Remote\Model
{
    ...
    {
        return ['StreetAddress' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'City' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'State' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Latitude' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Longitude' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'WorkLocationID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SuitOrAptOrUnit' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'IsPrimary' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

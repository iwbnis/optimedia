...
class TaxRate extends Remote\Model
{
    ...
    {
        return [Remote\Request::METHOD_GET, Remote\Request::METHOD_POST, Remote\Request::METHOD_PUT];
    }
    /**
    ...
    {
        return ['Name' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TaxType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'TaxComponents' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\TaxRate\\TaxComponent', \true, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'ReportTaxType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'CanApplyToAssets' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'CanApplyToEquity' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'CanApplyToExpenses' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'CanApplyToLiabilities' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'CanApplyToRevenue' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'DisplayTaxRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'EffectiveRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

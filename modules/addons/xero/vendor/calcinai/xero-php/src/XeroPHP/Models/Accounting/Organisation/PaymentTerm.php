...
class PaymentTerm extends Remote\Model
{
    ...
    {
        return ['Bills' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Organisation\\Bill', \true, \false], 'Sales' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Organisation\\Sale', \true, \false]];
    }
     ...
     * @return PaymentTerm
     */
    public function addBill(\XeroPHP\Models\Accounting\Organisation\Bill $value)
    {
     ...
     * @return PaymentTerm
     */
    public function addSale(\XeroPHP\Models\Accounting\Organisation\Sale $value)
    {

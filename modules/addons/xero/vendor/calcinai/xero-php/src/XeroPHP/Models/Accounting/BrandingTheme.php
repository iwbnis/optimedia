...
class BrandingTheme extends Remote\Model
{
    ...
    {
        return ['BrandingThemeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Name' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LogoUrl' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Type' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SortOrder' => [\false, self::PROPERTY_TYPE_INT, null, \false, \false], 'CreatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false]];
    }

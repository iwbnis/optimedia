...
class EarningsLine extends Remote\Model
{
    ...
    {
        return ['EarningsRateID' => [\false, self::PROPERTY_TYPE_GUID, null, \false, \false], 'CalculationType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'NumberOfUnitsPerWeek' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'AnnualSalary' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'RatePerUnit' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'NormalNumberOfUnits' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

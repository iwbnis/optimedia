...
class TimeOffType extends Remote\Model
{
    ...
    {
        return ['TimeOffType' => [\true, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\TimeOffType', \false, \false], 'TimeOffCategory' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'ExpenseAccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LiabilityAccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TimeOffTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ShowBalanceToEmployee' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

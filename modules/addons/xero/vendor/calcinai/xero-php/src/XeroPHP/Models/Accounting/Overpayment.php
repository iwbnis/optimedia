...
class Overpayment extends Remote\Model
{
    ...
    {
        return [Remote\Request::METHOD_GET, Remote\Request::METHOD_PUT];
    }
    /**
    ...
    {
        return ['Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Type' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Contact' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Contact', \false, \false], 'Date' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'LineAmountTypes' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'LineItems' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\LineItem', \true, \false], 'SubTotal' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'TotalTax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Total' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'CurrencyCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FullyPaidOnDate' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'OverpaymentID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CurrencyRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'RemainingCredit' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Allocations' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Overpayment\\Allocation', \true, \true], 'Payments' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Payment', \true, \false], 'HasAttachments' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'AppliedAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }
     ...
     * @return Overpayment
     */
    public function addPayment(\XeroPHP\Models\Accounting\Payment $value)
    {

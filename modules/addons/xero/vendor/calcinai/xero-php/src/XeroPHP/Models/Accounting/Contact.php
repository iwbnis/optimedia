...
class Contact extends Remote\Model
{
    ...
    {
        return [Remote\Request::METHOD_POST, Remote\Request::METHOD_PUT, Remote\Request::METHOD_GET];
    }
    /**
    ...
    {
        return ['ContactID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ContactNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ContactStatus' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Name' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FirstName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmailAddress' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SkypeUserName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ContactPersons' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Contact\\ContactPerson', \true, \false], 'BankAccountDetails' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TaxNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CompanyNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountsReceivableTaxType' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountsPayableTaxType' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Addresses' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Address', \true, \false], 'Phones' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Phone', \true, \false], 'IsSupplier' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'IsCustomer' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'DefaultCurrency' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'XeroNetworkKey' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SalesDefaultAccountCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PurchasesDefaultAccountCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SalesTrackingCategories' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\TrackingCategory', \true, \false], 'PurchasesTrackingCategories' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\TrackingCategory', \true, \false], 'TrackingCategoryName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TrackingCategoryOption' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaymentTerms' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Organisation\\PaymentTerm', \true, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'ContactGroups' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\ContactGroup', \true, \false], 'Website' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BrandingTheme' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\BrandingTheme', \false, \false], 'BatchPayments' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Discount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Balances' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'HasAttachments' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false]];
    }
     ...
     * @return Contact
     */
    public function addAddress(\XeroPHP\Models\Accounting\Address $value)
    {
     ...
     * @return Contact
     */
    public function addPhone(\XeroPHP\Models\Accounting\Phone $value)
    {
     ...
     * @return Contact
     */
    public function addSalesTrackingCategory(\XeroPHP\Models\Accounting\TrackingCategory $value)
    {
     ...
     * @return Contact
     */
    public function addPurchasesTrackingCategory(\XeroPHP\Models\Accounting\TrackingCategory $value)
    {
     ...
     * @return Contact
     */
    public function addContactGroup(\XeroPHP\Models\Accounting\ContactGroup $value)
    {
     ...
     * @return Contact
     */
    public function setBrandingTheme(\XeroPHP\Models\Accounting\BrandingTheme $value)
    {

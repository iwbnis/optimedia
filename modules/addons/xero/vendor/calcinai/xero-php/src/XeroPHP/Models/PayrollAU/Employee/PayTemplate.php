...
class PayTemplate extends Remote\Model
{
    ...
    {
        return ['EarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\PayTemplate\\EarningsLine', \true, \false], 'DeductionLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\PayTemplate\\DeductionLine', \true, \false], 'SuperLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\PayTemplate\\SuperLine', \true, \false], 'ReimbursementLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\PayTemplate\\ReimbursementLine', \true, \false], 'LeaveLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollAU\\Employee\\PayTemplate\\LeaveLine', \true, \false]];
    }

...
class Currency extends Remote\Model
{
    ...
    {
        return ['ModifiedAfter' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Code' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Description' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

...
class JournalLine extends Remote\Model
{
    ...
    {
        return ['LineAmount' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Description' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TaxType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Tracking' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\TrackingCategory', \true, \false], 'TaxAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

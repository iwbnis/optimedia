...
class Organisation extends Remote\Model
{
    ...
    {
        return ['APIKey' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Class' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Name' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LegalName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaysTax' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'Version' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'OrganisationType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'BaseCurrency' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CountryCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'IsDemoCompany' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'OrganisationStatus' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'RegistrationNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TaxNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FinancialYearEndDay' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FinancialYearEndMonth' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SalesTaxBasis' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'SalesTaxPeriod' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'DefaultSalesTax' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'DefaultPurchasesTax' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PeriodLockDate' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EndOfYearLockDate' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CreatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'Timezone' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'OrganisationEntityType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'ShortCode' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LineOfBusiness' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Addresses' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Address', \true, \false], 'Phones' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Phone', \true, \false], 'ExternalLinks' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Organisation\\ExternalLink', \true, \false], 'PaymentTerms' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Organisation\\PaymentTerm', \true, \false], 'OrganisationID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

...
class ContactPerson extends Remote\Model
{
    ...
    {
        return ['FirstName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'LastName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmailAddress' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'IncludeInEmails' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false]];
    }

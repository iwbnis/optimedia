...
class BenefitType extends Remote\Model
{
    ...
    {
        return ['BenefitType' => [\true, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\BenefitType', \false, \false], 'BenefitCategory' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'LiabilityAccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ExpenseAccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BenefitTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'StandardAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'CompanyMax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Percentage' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ShowBalanceOnPaystub' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

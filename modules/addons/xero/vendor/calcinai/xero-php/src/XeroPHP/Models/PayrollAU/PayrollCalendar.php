...
class PayrollCalendar extends Remote\Model
{
    ...
    {
        return ['PayrollCalendarID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Name' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CalendarType' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'StartDate' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'PaymentDate' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'ReferenceDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false]];
    }

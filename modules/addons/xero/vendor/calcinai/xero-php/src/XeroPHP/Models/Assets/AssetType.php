...
class AssetType extends Remote\Model
{
    ...
    {
        return [Remote\Request::METHOD_GET, Remote\Request::METHOD_POST];
    }
    /**
    ...
    {
        return ['assetTypeName' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'fixedAssetAccountId' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'depreciationExpenseAccountId' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'accumulatedDepreciationAccountId' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BookDepreciationSetting' => [\true, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\Assets\\AssetType\\BookDepreciationSetting', \false, \false], 'assetTypeId' => [\true, self::PROPERTY_TYPE_GUID, null, \false, \false], 'Locks' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

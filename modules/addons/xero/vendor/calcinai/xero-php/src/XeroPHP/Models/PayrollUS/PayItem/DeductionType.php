...
class DeductionType extends Remote\Model
{
    ...
    {
        return ['DeductionType' => [\true, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\DeductionType', \false, \false], 'DeductionCategory' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'CalculationType' => [\true, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'LiabilityAccountCode' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'DeductionTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'StandardAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'CompanyMax' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false]];
    }

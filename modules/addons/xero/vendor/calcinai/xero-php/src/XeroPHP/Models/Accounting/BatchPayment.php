...
class BatchPayment extends Remote\Model
{
    ...
    {
        return ['Account' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Account', \false, \false], 'Particulars' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Code' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Narrative' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Details' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BatchPaymentID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Date' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'Payments' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Payment', \true, \false], 'Type' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'TotalAmount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'IsReconciled' => [\false, self::PROPERTY_TYPE_BOOLEAN, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false]];
    }
     ...
     * @return BatchPayment
     */
    public function addPayments(\XeroPHP\Models\Accounting\Payment $value)
    {

...
class SuperFund extends Remote\Model
{
    ...
    {
        return ['Type' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'Name' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ABN' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'BSB' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'AccountName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ElectronicServiceAddress' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SuperFundID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmployerNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SPIN' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

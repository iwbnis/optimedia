...
class Journal extends Remote\Model
{
    ...
    {
        return ['JournalID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'JournalDate' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'JournalNumber' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'CreatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SourceID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'SourceType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'JournalLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Journal\\JournalLine', \true, \false]];
    }

...
class Attachment extends Model
{
    ...
    {
        return ['AttachmentID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'FileName' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Url' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'MimeType' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ContentLength' => [\false, self::PROPERTY_TYPE_INT, null, \false, \false]];
    }
    /**
    ...
    {
        return [Request::METHOD_GET, Request::METHOD_PUT, Request::METHOD_POST];
    }
    /**
    ...
    public static function createFromLocalFile($file_name, $mime_type = null)
    {
        ...
        $instance = new self();
        $instance->fromStringArray(['MimeType' => $mime_type, 'ContentLength' => $content_length, 'FileName' => $path_info['basename']]);
    ...
    public static function createFromBinary($data, $file_name, $mime_type)
    {
        ...
        $instance = new self();
        $instance->fromStringArray(['MimeType' => $mime_type, 'ContentLength' => $content_length, 'FileName' => $file_name]);

...
class TimeOffBalance extends Remote\Model
{
    ...
    {
        return ['TimeOffName' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TimeOffTypeId' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem', \false, \false], 'NumberOfUnits' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'TypeOfUnits' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem', \true, \false], 'EmployeeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

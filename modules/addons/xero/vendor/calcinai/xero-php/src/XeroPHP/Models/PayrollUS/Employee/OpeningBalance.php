...
class OpeningBalance extends Remote\Model
{
    ...
    {
        return ['EarningsLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\EarningsLine', \true, \false], 'BenefitLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\BenefitLine', \true, \false], 'DeductionLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\DeductionLine', \true, \false], 'ReimbursementLines' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\Paystub\\ReimbursementLine', \true, \false], 'EarningsTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Amount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'BenefitTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'DeductionTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'ReimbursementTypeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'EmployeeID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }

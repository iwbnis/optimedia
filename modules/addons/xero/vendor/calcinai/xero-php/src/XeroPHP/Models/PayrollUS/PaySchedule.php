...
class PaySchedule extends Remote\Model
{
    ...
    {
        return ['PayScheduleName' => [\true, self::PROPERTY_TYPE_STRING, null, \false, \false], 'PaymentDate' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'StartDate' => [\true, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'ScheduleType' => [\true, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'PayScheduleId' => [\false, self::PROPERTY_TYPE_GUID, null, \false, \false]];
    }

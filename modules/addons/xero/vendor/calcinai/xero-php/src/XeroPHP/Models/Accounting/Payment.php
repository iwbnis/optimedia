...
class Payment extends Remote\Model
{
    ...
    {
        return ['Invoice' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Invoice', \false, \false], 'CreditNote' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\CreditNote', \false, \false], 'Prepayment' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Prepayment', \false, \false], 'Overpayment' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Overpayment', \false, \false], 'Account' => [\false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Account', \false, \false], 'Date' => [\false, self::PROPERTY_TYPE_DATE, '\\DateTimeInterface', \false, \false], 'CurrencyRate' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Amount' => [\false, self::PROPERTY_TYPE_FLOAT, null, \false, \false], 'Reference' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Details' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'IsReconciled' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false], 'Status' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'PaymentType' => [\false, self::PROPERTY_TYPE_ENUM, null, \false, \false], 'UpdatedDateUTC' => [\false, self::PROPERTY_TYPE_TIMESTAMP, '\\DateTimeInterface', \false, \false], 'PaymentID' => [\false, self::PROPERTY_TYPE_STRING, null, \false, \false]];
    }
     ...
     * @return Payment
     */
    public function setInvoice(\XeroPHP\Models\Accounting\Invoice $value)
    {
     ...
     * @return Payment
     */
    public function setCreditNote(\XeroPHP\Models\Accounting\CreditNote $value)
    {
     ...
     * @return Payment
     */
    public function setPrepayment(\XeroPHP\Models\Accounting\Prepayment $value)
    {
     ...
     * @return Payment
     */
    public function setOverpayment(\XeroPHP\Models\Accounting\Overpayment $value)
    {
     ...
     * @return Payment
     */
    public function setAccount(\XeroPHP\Models\Accounting\Account $value)
    {

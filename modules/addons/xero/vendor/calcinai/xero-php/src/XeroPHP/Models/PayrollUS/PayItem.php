...
class PayItem extends Remote\Model
{
    ...
    {
        return ['EarningsTypes' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\EarningsType', \true, \false], 'BenefitTypes' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\BenefitType', \true, \false], 'DeductionTypes' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\DeductionType', \true, \false], 'ReimbursementTypes' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\ReimbursementType', \true, \false], 'TimeOffTypes' => [\false, self::PROPERTY_TYPE_OBJECT, 'EdgeHosting\\PayrollUS\\PayItem\\TimeOffType', \true, \false]];
    }

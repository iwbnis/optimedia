<div class="modal fade bs-example-modal-lg" id="mg-modal-inactive-entity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title">{$MGLANG->T('modal','Inactivate Popup')} <strong data-modal-title=""></strong></h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-inverse" data-modal-action="inactive" id="pm-modal-addip-button-add">{$MGLANG->T('modal','inactivate')}</button>

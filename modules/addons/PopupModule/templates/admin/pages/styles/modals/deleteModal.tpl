    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{$MGLANG->T('modal','Delete Style')} <strong data-modal-title=""></strong></h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <div style="margin: 30px; text-align: center;">
                    ...
                    <div>{$MGLANG->T('Are you sure you want to delete this entry from list?')} </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-inverse" data-modal-action="delete" id="pm-modal-addip-button-add">{$MGLANG->T('modal','delete')}</button>

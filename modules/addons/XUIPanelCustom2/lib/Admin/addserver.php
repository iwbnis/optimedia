    ...
    <table name="addserver" class="form" method="request" action="edit" id="" width="100%" border="0" cellspacing="2" cellpadding="3">
        <tbody>
            <tr>
                ...
                <td class="fieldarea"><input class="form-control input-400 validateclass" style="float: left;" type="text" name="panel_name" id="panel_name" value="<?php echo $Servernametoshow; ?>">
            ...
            <tr>
                ...
                <td class="fieldarea"><input class="form-control input-400 validateclass" style="float: left;" type="text" name="panel_url" id="panel_url" value="<?php echo $Servernametoshow; ?>">
                    <div style="font-size: 13px;  margin-top: 5px;"><i>(Your Panel Url)</i></div>
                </td>
            </tr>
            <tr>
                <td style="width: 25%;" class="fieldlabel">Username</td>
                <td class="fieldarea"><input class="form-control input-400 validateclass" style="float: left;" type="text" name="username" id="username" value="<?php echo $Servernametoshow; ?>">
                    <div style="font-size: 13px;  margin-top: 5px;"><i>(Username of your panel)</i></div>
                </td>
            </tr>
            <tr>
                <td style="width: 25%;" class="fieldlabel">Password</td>
                <td class="fieldarea"><input class="form-control input-400 validateclass" style="float: left;" type="text" name="password" id="password" value="<?php echo $Servernametoshow; ?>">
            ...
            <tr>
                ...
                <td class="fieldarea">
                    <input class="form-control input-400 validateclass" style="float: left;" type="text" name="mag_portal" id="mag_portal">
            ...
            <tr>
                ...
                <td class="fieldarea">
                    <input class="form-control input-400 validateclass" style="float: left;" type="text" name="m3uurl" id="m3uurl">
            ...
            <tr>
                ...
                <td class="fieldarea">
                    <input class="form-control input-400 validateclass" style="float: left;" type="text" name="watchstrmurl" id="watchstrmurl">

...
add_hook('ClientAreaProductDetailsOutput', 1, function($service) {
	...
	$gatewayParams = getGatewayVariables('StripeSmart<number>');

	$serviceId = $service['service']->id;
	
	$subs = Capsule::table('gateway_stripeSmart<number>_Subscriptions')
	...
	if($_GET['customAction'] == 'cancelSubscription')
	{
		  ...
		  logActivity("StripeSmart<number>: Subscription Cancel Status: $status -  Action Respose: $json_response");		

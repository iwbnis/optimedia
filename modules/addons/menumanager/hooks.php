 ...
 * @copyright  Copyright (c) ModulesCastle 2015-2019
...
function MenuManagerHook_loadAdminAreaFiles($vars){
    ...
    if ($vars['filename']=="addonmodules" && $_GET['module']=="menumanager"){
        ...
        if (version_compare("7.8", $CONFIG['Version'], '<') === true){
            $HTML .= '<script type="text/javascript" src="../modules/addons/menumanager/assets/js/jqueryui/jquery-ui.min.js"></script>';
            $HTML .= '<link type="text/css" rel="stylesheet" href="../modules/addons/menumanager/assets/js/jqueryui/jquery-ui.min.css">';
        }
...
## Fix Javascript Commands Added as URL, when WHMCS is installed inside subdirectory
            ...
            foreach ($level1['children'] as $level2){
                ...
                if (is_array($level2['children']) && count($level2['children'])>0){
                    ...
                    foreach ($level2['children'] as $level3){
                        ...
                        if (stripos($level3['fullurl'], "javascript:") !== false){
                            $itemClasses[] = "manu-manager-javascript-link";
                        }
                        ...
                        if (is_array($level3['children']) && count($level3['children'])>0){
                            ...
                            foreach ($level3['children'] as $level4){
                                ...
                                if (stripos($level4['fullurl'], "javascript:") !== false){
                                    $itemClasses[] = "manu-manager-javascript-link";
                                }

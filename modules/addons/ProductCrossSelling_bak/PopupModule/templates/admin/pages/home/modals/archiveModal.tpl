...
*}
<div class="modal fade bs-example-modal-lg" id="mg-modal-archive-entity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-inverse" data-modal-action="archive" id="pm-modal-addip-button-add">{$MGLANG->T('modal','move')}</button>

...
<form data-toggle="validator" role="form" id="mg-popup-form">
    <div class="modal modal-tabed fade bs-example-modal-lg" id="mg-modal-add-new" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title">{$MGLANG->T('Add New Popup')} <strong></strong></h4>
                    <ul class="nav nav-tabs text-right" role="tablist">
                        ...
                        <li><a href="#lookandfeel-tab" role="tab" data-toggle="tab">{$MGLANG->T('lookandfeel')}</a></li>
                        <li><a href="#restrictions-tab" role="tab" data-toggle="tab">{$MGLANG->T('restrictions')}</a></li>
                        <li><a href="#duedate-tab" role="tab" data-toggle="tab">{$MGLANG->T('duedate')}</a></li>
                        <li><a href="#timing-tab" role="tab" data-toggle="tab">{$MGLANG->T('timing')}</a></li>
                    </ul>
                </div>

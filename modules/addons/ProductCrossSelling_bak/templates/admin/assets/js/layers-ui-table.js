...
(function (factory) {
  ...
  */
   ...
   */
		...
		/**
   * DetailsProductButton control. If given as a string value, the `type` property of the
  ...
  */
   ...
   */
    ...
    */
			...
			/**
    * DetailsProductButton the actions that will be taken when the user types into the

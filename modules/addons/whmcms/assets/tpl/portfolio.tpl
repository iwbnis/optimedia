            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li role="presentation"><a href="#addcategory_meta" aria-controls="addcategory_meta" role="tab" data-toggle="tab">{WHMCMS::__("portfolioCategoryCreateMeta")}</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="addcategory_meta">
                            {$categoryMeta}
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li role="presentation"><a href="#editcategory_meta_{$category.categoryid}" aria-controls="addcategory_meta" role="tab" data-toggle="tab">{WHMCMS::__("portfolioCategoryCreateMeta")}</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="editcategory_meta_{$category.categoryid}">
